...
import NPB.updated.NPB3_0_JAV.CGThreads_alt.*;
...
public class CG_alt extends CGBase {
	public int bid=-1;
...
//---------------------------------------------------------------------
	...
	private void ExecuteTask(int OrderNum) throws Exception {
...
//   	worker[m].notify();
//      }
			masterEnvironment.send(new CGMessage(OrderNum, alpha, beta), "worker_"+m+"_"); // TODO Place use of exchange here!

...
public class Interp extends MGBase {
    ...
    public IEnvironment interpEnvironment;

    public Interp(MG mg, IEnvironment interpEnvironment){
        Init(mg);
        int m=535;
        z1=new double[m];
        z2=new double[m];
        ...
        setDaemon(true);
        master=mg;
        this.interpEnvironment = interpEnvironment;
    }
    void Init(MG mg){
...
//	    }
            ...
            try
            {
                ...
                if (o instanceof InterpMessage) {
                    ...
                    GetWork();
                    step();
                    interpEnvironment.send(new DoneMessage());
                }

...
public class Psinv extends MGBase {
    ...
    public IEnvironment psinvEnvironment;

    public Psinv(MG mg, IEnvironment psinvEnvironment){
        Init(mg);
        r1=new double[nm+1];
        r2=new double[nm+1];
        ...
        setDaemon(true);
        master=mg;
        this.psinvEnvironment = psinvEnvironment;
    }
    void Init(MG mg){
...
//          }
            try {
                ...
                if (o instanceof PsinvMessage) {
                    ...
                    GetWork();
                    step();
                    psinvEnvironment.send(new DoneMessage());
                }

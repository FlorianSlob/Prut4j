...
public class Rprj extends MGBase {
    private final IEnvironment rprjEnvironment;
    public int id;
    ...
    public Rprj(MG mg, IEnvironment rprjEnvironment){
        Init(mg);
        x1=new double[nm+1];
        y1=new double[nm+1];
        ...
        setDaemon(true);
        master=mg;
        this.rprjEnvironment = rprjEnvironment;
    }
...
//    	}
            try {
                ...
                if (o instanceof RprjMessage) {
                    ...
                    GetWork();
                    step();
                    rprjEnvironment.send(new DoneMessage());
                }

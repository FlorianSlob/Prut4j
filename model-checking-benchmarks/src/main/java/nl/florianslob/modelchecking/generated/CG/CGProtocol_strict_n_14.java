...
public class CGProtocol_strict_n_14 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_141(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 1 :
						case 2 :
						case 4 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 141){
								Optional result = exchange_0_141(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "master","worker_3_","worker_10_","worker_0_","worker_8_","worker_6_","worker_12_","worker_9_","worker_1_","worker_11_","worker_13_","worker_4_","worker_5_","worker_7_","worker_2_" };
	}

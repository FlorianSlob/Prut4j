...
public class CGProtocol_strict_alt_n_11 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_25(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(11);
									String[] receiverOptionsArray = new String[]{ "worker_1_","worker_3_","worker_5_","worker_7_","worker_2_","worker_0_","worker_6_","worker_4_","worker_8_","worker_10_","worker_9_" };
						...
						case 15:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(11);
									String[] receiverOptionsArray = new String[]{ "worker_1_","worker_10_","worker_2_","worker_6_","worker_3_","worker_0_","worker_9_","worker_7_","worker_5_","worker_4_","worker_8_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_1_")) {
									setState(18);
						...
						case 17:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(11);
									String[] receiverOptionsArray = new String[]{ "worker_4_","worker_5_","worker_9_","worker_0_","worker_8_","worker_2_","worker_3_","worker_6_","worker_10_","worker_1_","worker_7_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_4_")) {
									setState(21);
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					...
					while (true){
						if (state >=0 && state <= 25){
							Optional result = exchange_0_25(box, receiver, isCloseAction);
							if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_4_","master","worker_0_","worker_3_","worker_9_","worker_5_","worker_10_","worker_6_","worker_2_","worker_7_","worker_8_","worker_1_" };
	}

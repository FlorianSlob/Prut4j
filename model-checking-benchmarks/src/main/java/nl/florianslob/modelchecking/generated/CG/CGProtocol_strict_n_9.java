...
public class CGProtocol_strict_n_9 implements IProtocol {
			...
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 91){
								var result = exchange_0_91(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "master","worker_7_","worker_6_","worker_1_","worker_3_","worker_2_","worker_0_","worker_4_","worker_8_","worker_5_" };
	}

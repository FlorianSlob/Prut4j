...
public class CGProtocol_strict_n_15 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 151){
								var result = exchange_0_151(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_6_","worker_11_","worker_10_","worker_2_","worker_3_","worker_13_","worker_0_","worker_7_","master","worker_1_","worker_5_","worker_4_","worker_12_","worker_8_","worker_14_","worker_9_" };
	}

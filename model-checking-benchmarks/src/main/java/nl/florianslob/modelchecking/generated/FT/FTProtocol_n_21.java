...
public class FTProtocol_n_21 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "evolve_0_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_400_460(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 400 :
						case 401 :
						case 402 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							...
							if (state >=400 && state <= 460){
								Optional result = exchange_400_460(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "fft_10_","fft_4_","evolve_19_","master","fft_18_","evolve_6_","evolve_17_","fft_14_","evolve_4_","evolve_10_","evolve_5_","fft_17_","fft_5_","fft_9_","fft_15_","evolve_13_","evolve_7_","fft_1_","evolve_11_","evolve_3_","fft_11_","evolve_8_","fft_16_","evolve_16_","fft_12_","fft_20_","fft_8_","fft_13_","evolve_9_","evolve_14_","evolve_1_","evolve_0_","evolve_15_","evolve_18_","fft_2_","fft_6_","fft_7_","fft_0_","evolve_20_","evolve_2_","evolve_12_","fft_3_","fft_19_" };
	}

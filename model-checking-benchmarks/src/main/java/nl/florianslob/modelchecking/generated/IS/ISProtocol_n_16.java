...
public class ISProtocol_n_16 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_161(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 1 :
						case 2 :
						case 4 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 161){
								Optional result = exchange_0_161(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_12_","worker_3_","worker_4_","worker_7_","worker_14_","master","worker_5_","worker_1_","worker_13_","worker_10_","worker_15_","worker_2_","worker_0_","worker_9_","worker_6_","worker_11_","worker_8_" };
	}

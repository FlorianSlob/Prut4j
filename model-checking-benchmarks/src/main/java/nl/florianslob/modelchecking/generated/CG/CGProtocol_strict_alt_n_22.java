...
public class CGProtocol_strict_alt_n_22 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_47(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(22);
									String[] receiverOptionsArray = new String[]{ "worker_11_","worker_15_","worker_8_","worker_12_","worker_3_","worker_21_","worker_13_","worker_1_","worker_7_","worker_6_","worker_16_","worker_18_","worker_19_","worker_2_","worker_17_","worker_4_","worker_10_","worker_20_","worker_14_","worker_9_","worker_5_","worker_0_" };
						...
						case 8:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(22);
									String[] receiverOptionsArray = new String[]{ "worker_19_","worker_15_","worker_3_","worker_7_","worker_9_","worker_1_","worker_16_","worker_6_","worker_5_","worker_4_","worker_0_","worker_8_","worker_18_","worker_13_","worker_20_","worker_11_","worker_21_","worker_14_","worker_12_","worker_10_","worker_17_","worker_2_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_19_")) {
									setState(7);
						...
						case 12:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(22);
									String[] receiverOptionsArray = new String[]{ "worker_0_","worker_16_","worker_14_","worker_10_","worker_8_","worker_17_","worker_5_","worker_13_","worker_21_","worker_7_","worker_11_","worker_6_","worker_20_","worker_1_","worker_19_","worker_12_","worker_9_","worker_3_","worker_15_","worker_18_","worker_2_","worker_4_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_0_")) {
									setState(10);
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					...
					while (true){
						if (state >=0 && state <= 47){
							Optional result = exchange_0_47(box, receiver, isCloseAction);
							if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_9_","worker_5_","worker_0_","worker_21_","worker_7_","worker_1_","worker_16_","worker_13_","master","worker_3_","worker_4_","worker_2_","worker_12_","worker_10_","worker_18_","worker_6_","worker_15_","worker_14_","worker_8_","worker_20_","worker_11_","worker_19_","worker_17_" };
	}

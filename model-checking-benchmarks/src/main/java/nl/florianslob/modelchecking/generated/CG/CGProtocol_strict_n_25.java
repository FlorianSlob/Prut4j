...
public class CGProtocol_strict_n_25 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_200_251(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 225 :
						case 226 :
						case 227 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 251){
								Optional result = exchange_200_251(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "worker_18_","master","worker_0_","worker_16_","worker_17_","worker_15_","worker_10_","worker_5_","worker_24_","worker_12_","worker_19_","worker_22_","worker_20_","worker_6_","worker_11_","worker_8_","worker_3_","worker_7_","worker_13_","worker_4_","worker_21_","worker_2_","worker_9_","worker_1_","worker_14_","worker_23_" };
	}

...
public class FTProtocol_n_18 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "evolve_0_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_200_394(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 200 :
						case 201 :
						case 202 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 394){
								Optional result = exchange_200_394(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "fft_13_","fft_6_","evolve_11_","evolve_6_","evolve_1_","fft_9_","evolve_5_","fft_10_","evolve_8_","evolve_2_","fft_0_","fft_2_","evolve_15_","fft_7_","fft_5_","evolve_14_","fft_11_","fft_4_","evolve_12_","fft_8_","fft_14_","evolve_13_","evolve_4_","fft_3_","evolve_3_","fft_16_","evolve_9_","evolve_10_","master","evolve_0_","fft_12_","evolve_17_","evolve_16_","fft_1_","evolve_7_","fft_15_","fft_17_" };
	}

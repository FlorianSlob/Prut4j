...
public class CGProtocol_strict_n_23 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 231){
								var result = exchange_200_231(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "worker_14_","worker_1_","worker_19_","worker_7_","worker_17_","worker_13_","worker_21_","worker_0_","worker_8_","worker_10_","worker_18_","worker_11_","worker_4_","worker_16_","worker_12_","worker_6_","worker_20_","worker_5_","worker_9_","master","worker_22_","worker_3_","worker_2_","worker_15_" };
	}

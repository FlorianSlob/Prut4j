...
public class CGProtocol_strict_n_23 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_200_231(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 207 :
						case 208 :
						case 209 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 231){
								Optional result = exchange_200_231(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "worker_12_","worker_20_","worker_17_","worker_14_","worker_19_","worker_2_","worker_6_","master","worker_22_","worker_16_","worker_0_","worker_9_","worker_18_","worker_4_","worker_5_","worker_21_","worker_3_","worker_10_","worker_7_","worker_15_","worker_1_","worker_8_","worker_11_","worker_13_" };
	}

...
public class ISProtocol_n_13 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 131){
								var result = exchange_0_131(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_8_","worker_2_","worker_10_","worker_1_","worker_9_","worker_5_","worker_12_","worker_6_","worker_7_","worker_11_","worker_3_","worker_4_","master","worker_0_" };
	}

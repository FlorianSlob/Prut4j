...
public class FTProtocol_n_7 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 152){
								Optional result = exchange_0_152(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "master","evolve_6_","fft_6_","evolve_1_","evolve_3_","evolve_0_","fft_3_","evolve_2_","fft_5_","fft_4_","fft_0_","fft_1_","evolve_4_","fft_2_","evolve_5_" };
	}

...
public class FTProtocol_n_16 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "evolve_0_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_200_350(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 200 :
						case 201 :
						case 202 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 350){
								Optional result = exchange_200_350(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "fft_15_","evolve_14_","fft_11_","evolve_4_","fft_10_","master","evolve_12_","evolve_6_","fft_7_","evolve_2_","fft_0_","evolve_7_","evolve_5_","fft_12_","fft_4_","fft_2_","evolve_1_","evolve_0_","evolve_9_","evolve_13_","fft_3_","fft_6_","fft_9_","fft_8_","evolve_10_","fft_1_","fft_5_","evolve_3_","evolve_15_","evolve_8_","evolve_11_","fft_13_","fft_14_" };
	}

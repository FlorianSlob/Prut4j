...
public class CGProtocol_strict_n_32 implements IProtocol {
	private volatile int state = 0;
	private final Object monitor = this;
	
	private final BlockingQueue<Object> queueFrommasterToworker_6_ = new LinkedBlockingQueue<>(); 
	private final BlockingQueue<Object> queueFrommasterToworker_28_ = new LinkedBlockingQueue<>(); 
	...
	private final BlockingQueue<Object> queueFromworker_30_Tomaster = new LinkedBlockingQueue<>(); 
	...
	private final BlockingQueue<Object> queueFrommasterToworker_31_ = new LinkedBlockingQueue<>(); 
	private final BlockingQueue<Object> queueFrommasterToworker_27_ = new LinkedBlockingQueue<>(); 
	...
	private final BlockingQueue<Object> queueFromworker_27_Tomaster = new LinkedBlockingQueue<>(); 
	...
	private final BlockingQueue<Object> queueFrommasterToworker_30_ = new LinkedBlockingQueue<>(); 
	private final BlockingQueue<Object> queueFromworker_29_Tomaster = new LinkedBlockingQueue<>(); 
	...
	private final BlockingQueue<Object> queueFrommasterToworker_26_ = new LinkedBlockingQueue<>(); 
	...
	private final BlockingQueue<Object> queueFromworker_31_Tomaster = new LinkedBlockingQueue<>(); 
	private final BlockingQueue<Object> queueFrommasterToworker_29_ = new LinkedBlockingQueue<>(); 
	...
	private final BlockingQueue<Object> queueFromworker_28_Tomaster = new LinkedBlockingQueue<>(); 
	private final BlockingQueue<Object> queueFromworker_5_Tomaster = new LinkedBlockingQueue<>(); 
	private final BlockingQueue<Object> queueFromworker_26_Tomaster = new LinkedBlockingQueue<>(); 
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
					...
					switch (state){
						...
						case 53:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
								...
								if (receiver.equals("worker_26_")) {
									monitor.notifyAll();
									state = 54;
									queueFrommasterToworker_26_.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
						...
						case 55:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
								...
								if (receiver.equals("worker_27_")) {
									monitor.notifyAll();
									state = 56;
									queueFrommasterToworker_27_.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
						...
						case 57:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
								...
								if (receiver.equals("worker_28_")) {
									monitor.notifyAll();
									state = 58;
									queueFrommasterToworker_28_.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
						...
						case 59:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
								...
								if (receiver.equals("worker_29_")) {
									monitor.notifyAll();
									state = 60;
									queueFrommasterToworker_29_.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
						...
						case 61:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
								...
								if (receiver.equals("worker_30_")) {
									monitor.notifyAll();
									state = 62;
									queueFrommasterToworker_30_.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
						...
						case 63:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
								...
								if (receiver.equals("worker_31_")) {
									monitor.notifyAll();
									state = 64;
									queueFrommasterToworker_31_.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
						...
						case 116:
							...
							break;
						case 118:
							if (queueFromworker_26_Tomaster.peek() != null ) {
								monitor.notifyAll();
								state = 119;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFromworker_26_Tomaster.take());
							}
							monitor.wait();
							break;
						case 120:
							if (queueFromworker_27_Tomaster.peek() != null ) {
								monitor.notifyAll();
								state = 121;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFromworker_27_Tomaster.take());
							}
							monitor.wait();
							break;
						case 122:
							if (queueFromworker_28_Tomaster.peek() != null ) {
								monitor.notifyAll();
								state = 123;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFromworker_28_Tomaster.take());
							}
							monitor.wait();
							break;
						case 124:
							if (queueFromworker_29_Tomaster.peek() != null ) {
								monitor.notifyAll();
								state = 125;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFromworker_29_Tomaster.take());
							}
							monitor.wait();
							break;
						case 126:
							if (queueFromworker_30_Tomaster.peek() != null ) {
								monitor.notifyAll();
								state = 127;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFromworker_30_Tomaster.take());
							}
							monitor.wait();
							break;
						case 128:
							if (queueFromworker_31_Tomaster.peek() != null ) {
								monitor.notifyAll();
								state = 129;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFromworker_31_Tomaster.take());
							}
							monitor.wait();
							break;
						case 129:
				...
				public <Any, AnyInput> Optional<Any> exchange_200_321(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 201 :
						case 202 :
						case 205 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 321){
								var result = exchange_200_321(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
			...
			case "worker_26_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_199(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 199 :
							...
							break;
						case 54:
							if (queueFrommasterToworker_26_.peek() != null ) {
								monitor.notifyAll();
								state = 55;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFrommasterToworker_26_.take());
							}
							monitor.wait();
							break;
						case 117:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
								...
								if (receiver.equals("master")) {
									monitor.notifyAll();
									state = 118;
									queueFromworker_26_Tomaster.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
			...
			case "worker_27_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_199(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 199 :
							...
							break;
						case 56:
							if (queueFrommasterToworker_27_.peek() != null ) {
								monitor.notifyAll();
								state = 57;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFrommasterToworker_27_.take());
							}
							monitor.wait();
							break;
						case 119:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
								...
								if (receiver.equals("master")) {
									monitor.notifyAll();
									state = 120;
									queueFromworker_27_Tomaster.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
			...
			case "worker_28_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_199(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 199 :
							...
							break;
						case 58:
							if (queueFrommasterToworker_28_.peek() != null ) {
								monitor.notifyAll();
								state = 59;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFrommasterToworker_28_.take());
							}
							monitor.wait();
							break;
						case 121:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
								...
								if (receiver.equals("master")) {
									monitor.notifyAll();
									state = 122;
									queueFromworker_28_Tomaster.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
			...
			case "worker_29_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_199(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 199 :
							...
							break;
						case 60:
							if (queueFrommasterToworker_29_.peek() != null ) {
								monitor.notifyAll();
								state = 61;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFrommasterToworker_29_.take());
							}
							monitor.wait();
							break;
						case 123:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
								...
								if (receiver.equals("master")) {
									monitor.notifyAll();
									state = 124;
									queueFromworker_29_Tomaster.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
			...
			case "worker_30_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_199(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 199 :
							...
							break;
						case 62:
							if (queueFrommasterToworker_30_.peek() != null ) {
								monitor.notifyAll();
								state = 63;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFrommasterToworker_30_.take());
							}
							monitor.wait();
							break;
						case 125:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
								...
								if (receiver.equals("master")) {
									monitor.notifyAll();
									state = 126;
									queueFromworker_30_Tomaster.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
			...
			case "worker_31_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_199(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 199 :
							...
							break;
						case 64:
							if (queueFrommasterToworker_31_.peek() != null ) {
								monitor.notifyAll();
								state = 65;
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
								return Optional.of((Any)queueFrommasterToworker_31_.take());
							}
							monitor.wait();
							break;
						case 127:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
								...
								if (receiver.equals("master")) {
									monitor.notifyAll();
									state = 128;
									queueFromworker_31_Tomaster.put(box.get());
									return Optional.empty();
								}
							}
							monitor.wait();
	...
	public String[] threadNames(){
		return new String[] { "worker_19_","worker_25_","worker_15_","worker_21_","worker_7_","worker_8_","worker_29_","worker_1_","worker_16_","worker_20_","worker_27_","worker_26_","worker_18_","worker_5_","worker_4_","worker_31_","worker_13_","worker_3_","worker_30_","worker_28_","worker_23_","worker_24_","worker_17_","worker_6_","worker_14_","worker_11_","worker_22_","worker_2_","worker_12_","worker_0_","worker_9_","master","worker_10_" };
	}

...
public class CGProtocol_strict_alt_n_18 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_39(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(18);
									String[] receiverOptionsArray = new String[]{ "worker_13_","worker_5_","worker_1_","worker_4_","worker_9_","worker_12_","worker_15_","worker_3_","worker_10_","worker_6_","worker_0_","worker_11_","worker_2_","worker_7_","worker_14_","worker_16_","worker_17_","worker_8_" };
						...
						case 3:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(18);
									String[] receiverOptionsArray = new String[]{ "worker_12_","worker_0_","worker_17_","worker_6_","worker_4_","worker_15_","worker_10_","worker_3_","worker_2_","worker_1_","worker_16_","worker_7_","worker_14_","worker_11_","worker_13_","worker_9_","worker_5_","worker_8_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_12_")) {
									setState(18);
						...
						case 7:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(18);
									String[] receiverOptionsArray = new String[]{ "worker_16_","worker_8_","worker_0_","worker_3_","worker_14_","worker_2_","worker_13_","worker_5_","worker_11_","worker_17_","worker_12_","worker_10_","worker_15_","worker_6_","worker_4_","worker_1_","worker_9_","worker_7_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_16_")) {
									setState(32);
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					...
					while (true){
						if (state >=0 && state <= 39){
							Optional result = exchange_0_39(box, receiver, isCloseAction);
							if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_1_","master","worker_7_","worker_16_","worker_10_","worker_9_","worker_2_","worker_12_","worker_3_","worker_0_","worker_8_","worker_5_","worker_17_","worker_6_","worker_11_","worker_13_","worker_4_","worker_15_","worker_14_" };
	}

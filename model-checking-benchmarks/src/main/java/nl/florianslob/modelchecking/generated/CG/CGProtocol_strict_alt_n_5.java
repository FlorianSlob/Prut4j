...
public class CGProtocol_strict_alt_n_5 implements IProtocol {
					...
					switch (state){
						...
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									...
									String[] receiverOptionsArray = new String[]{ "worker_1_","worker_3_","worker_0_","worker_4_","worker_2_" };
						...
						case 17:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(5);
									String[] receiverOptionsArray = new String[]{ "worker_0_","worker_1_","worker_2_","worker_3_","worker_4_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_0_")) {
									monitor.notifyAll();
						...
						case 25:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(5);
									String[] receiverOptionsArray = new String[]{ "worker_1_","worker_0_","worker_3_","worker_2_","worker_4_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_1_")) {
									monitor.notifyAll();
	...
	public String[] threadNames(){
		return new String[] { "worker_4_","master","worker_2_","worker_0_","worker_1_","worker_3_" };
	}

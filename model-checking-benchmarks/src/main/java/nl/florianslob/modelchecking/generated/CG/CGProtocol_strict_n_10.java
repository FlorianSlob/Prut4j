...
public class CGProtocol_strict_n_10 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 101){
								var result = exchange_0_101(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_8_","worker_7_","worker_4_","worker_0_","worker_9_","worker_6_","worker_1_","worker_5_","worker_2_","worker_3_","master" };
	}

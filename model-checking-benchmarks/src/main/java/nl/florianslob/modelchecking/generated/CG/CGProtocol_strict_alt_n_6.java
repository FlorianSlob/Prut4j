...
public class CGProtocol_strict_alt_n_6 implements IProtocol {
					...
					switch (state){
						...
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									...
									String[] receiverOptionsArray = new String[]{ "worker_5_","worker_4_","worker_2_","worker_1_","worker_3_","worker_0_" };
						...
						case 20:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(6);
									String[] receiverOptionsArray = new String[]{ "worker_1_","worker_4_","worker_2_","worker_0_","worker_5_","worker_3_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_1_")) {
									monitor.notifyAll();
						...
						case 29:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(6);
									String[] receiverOptionsArray = new String[]{ "worker_3_","worker_5_","worker_2_","worker_0_","worker_1_","worker_4_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_3_")) {
									monitor.notifyAll();
	...
	public String[] threadNames(){
		return new String[] { "worker_2_","worker_4_","worker_0_","worker_1_","worker_5_","master","worker_3_" };
	}

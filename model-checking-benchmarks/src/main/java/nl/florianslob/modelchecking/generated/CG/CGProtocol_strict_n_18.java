...
public class CGProtocol_strict_n_18 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_181(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 1 :
						case 2 :
						case 4 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 181){
								Optional result = exchange_0_181(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_15_","worker_11_","worker_2_","worker_9_","worker_0_","master","worker_16_","worker_14_","worker_13_","worker_4_","worker_17_","worker_12_","worker_1_","worker_5_","worker_6_","worker_8_","worker_7_","worker_3_","worker_10_" };
	}

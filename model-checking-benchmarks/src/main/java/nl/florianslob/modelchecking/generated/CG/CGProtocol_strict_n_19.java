...
public class CGProtocol_strict_n_19 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_191(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 1 :
						case 2 :
						case 4 :
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 191){
								Optional result = exchange_0_191(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_7_","worker_4_","worker_13_","worker_18_","worker_8_","worker_2_","worker_14_","worker_3_","worker_10_","worker_17_","worker_5_","worker_9_","worker_12_","worker_15_","worker_0_","worker_6_","worker_11_","master","worker_1_","worker_16_" };
	}

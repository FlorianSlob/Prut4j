...
public class CGProtocol_strict_alt_n_13 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_82(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 1 :
						case 2 :
						case 4 :
						...
						case 0:
							...
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									...
									String[] receiverOptionsArray = new String[]{ "worker_5_","worker_8_","worker_9_","worker_6_","worker_10_","worker_7_","worker_11_","worker_0_","worker_1_","worker_3_","worker_12_","worker_2_","worker_4_" };
						...
						case 41:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(13);
									String[] receiverOptionsArray = new String[]{ "worker_6_","worker_1_","worker_7_","worker_5_","worker_0_","worker_12_","worker_2_","worker_8_","worker_10_","worker_9_","worker_3_","worker_11_","worker_4_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_6_")) {
									monitor.notifyAll();
						...
						case 57:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(13);
									String[] receiverOptionsArray = new String[]{ "worker_9_","worker_0_","worker_2_","worker_1_","worker_6_","worker_11_","worker_10_","worker_4_","worker_8_","worker_5_","worker_7_","worker_12_","worker_3_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_9_")) {
									monitor.notifyAll();
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 82){
								Optional result = exchange_0_82(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_12_","worker_1_","master","worker_7_","worker_8_","worker_9_","worker_5_","worker_10_","worker_11_","worker_2_","worker_4_","worker_6_","worker_3_","worker_0_" };
	}

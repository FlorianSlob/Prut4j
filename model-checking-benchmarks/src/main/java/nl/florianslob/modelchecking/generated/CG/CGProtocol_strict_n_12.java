...
public class CGProtocol_strict_n_12 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 121){
								var result = exchange_0_121(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "master","worker_3_","worker_10_","worker_8_","worker_7_","worker_9_","worker_11_","worker_2_","worker_5_","worker_0_","worker_1_","worker_4_","worker_6_" };
	}

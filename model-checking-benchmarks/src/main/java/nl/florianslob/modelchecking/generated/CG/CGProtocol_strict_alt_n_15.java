...
public class CGProtocol_strict_alt_n_15 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_33(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(15);
									String[] receiverOptionsArray = new String[]{ "worker_12_","worker_11_","worker_0_","worker_1_","worker_13_","worker_4_","worker_3_","worker_5_","worker_14_","worker_7_","worker_10_","worker_8_","worker_2_","worker_6_","worker_9_" };
						...
						case 2:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(15);
									String[] receiverOptionsArray = new String[]{ "worker_8_","worker_10_","worker_7_","worker_1_","worker_11_","worker_4_","worker_9_","worker_0_","worker_5_","worker_13_","worker_2_","worker_14_","worker_3_","worker_6_","worker_12_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_8_")) {
									setState(18);
						...
						case 29:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(15);
									String[] receiverOptionsArray = new String[]{ "worker_6_","worker_2_","worker_11_","worker_7_","worker_1_","worker_0_","worker_14_","worker_3_","worker_12_","worker_13_","worker_8_","worker_10_","worker_5_","worker_4_","worker_9_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_6_")) {
									setState(11);
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					...
					while (true){
						if (state >=0 && state <= 33){
							Optional result = exchange_0_33(box, receiver, isCloseAction);
							if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_9_","worker_4_","worker_12_","worker_0_","worker_8_","master","worker_6_","worker_13_","worker_7_","worker_5_","worker_1_","worker_14_","worker_3_","worker_10_","worker_2_","worker_11_" };
	}

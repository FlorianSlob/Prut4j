...
public class CGProtocol_strict_alt_n_15 implements IProtocol {
					...
					switch (state){
						...
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									...
									String[] receiverOptionsArray = new String[]{ "worker_12_","worker_1_","worker_9_","worker_8_","worker_14_","worker_3_","worker_0_","worker_10_","worker_11_","worker_5_","worker_6_","worker_13_","worker_7_","worker_2_","worker_4_" };
						...
						case 47:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(15);
									String[] receiverOptionsArray = new String[]{ "worker_5_","worker_7_","worker_0_","worker_11_","worker_6_","worker_14_","worker_4_","worker_8_","worker_1_","worker_2_","worker_12_","worker_3_","worker_13_","worker_10_","worker_9_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_5_")) {
									monitor.notifyAll();
						...
						case 65:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(15);
									String[] receiverOptionsArray = new String[]{ "worker_7_","worker_1_","worker_3_","worker_9_","worker_11_","worker_0_","worker_13_","worker_5_","worker_4_","worker_8_","worker_6_","worker_10_","worker_14_","worker_12_","worker_2_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_7_")) {
									monitor.notifyAll();
	...
	public String[] threadNames(){
		return new String[] { "worker_8_","worker_6_","worker_10_","worker_0_","worker_14_","worker_3_","worker_2_","worker_13_","worker_9_","worker_4_","worker_7_","worker_12_","worker_11_","worker_5_","worker_1_","master" };
	}

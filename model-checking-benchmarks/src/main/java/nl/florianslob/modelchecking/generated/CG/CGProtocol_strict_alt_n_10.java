...
public class CGProtocol_strict_alt_n_10 implements IProtocol {
					...
					switch (state){
						...
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									...
									String[] receiverOptionsArray = new String[]{ "worker_1_","worker_5_","worker_9_","worker_7_","worker_8_","worker_4_","worker_0_","worker_6_","worker_2_","worker_3_" };
						...
						case 32:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(10);
									String[] receiverOptionsArray = new String[]{ "worker_8_","worker_9_","worker_7_","worker_1_","worker_4_","worker_0_","worker_6_","worker_5_","worker_3_","worker_2_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_8_")) {
									monitor.notifyAll();
						...
						case 45:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(10);
									String[] receiverOptionsArray = new String[]{ "worker_7_","worker_2_","worker_3_","worker_5_","worker_4_","worker_1_","worker_9_","worker_0_","worker_6_","worker_8_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_7_")) {
									monitor.notifyAll();
	...
	public String[] threadNames(){
		return new String[] { "worker_6_","worker_1_","worker_9_","worker_0_","worker_8_","worker_3_","worker_4_","worker_2_","worker_7_","worker_5_","master" };
	}

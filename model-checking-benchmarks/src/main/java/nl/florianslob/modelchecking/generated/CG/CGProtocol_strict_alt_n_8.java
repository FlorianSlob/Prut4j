...
public class CGProtocol_strict_alt_n_8 implements IProtocol {
					...
					switch (state){
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									...
									String[] receiverOptionsArray = new String[]{ "worker_7_","worker_3_","worker_4_","worker_1_","worker_5_","worker_2_","worker_0_","worker_6_" };
						...
						case 3:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(8);
									String[] receiverOptionsArray = new String[]{ "worker_0_","worker_1_","worker_7_","worker_2_","worker_6_","worker_3_","worker_4_","worker_5_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_0_")) {
									setState(2);
						...
						case 10:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(8);
									String[] receiverOptionsArray = new String[]{ "worker_7_","worker_3_","worker_0_","worker_2_","worker_6_","worker_1_","worker_4_","worker_5_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_7_")) {
									setState(15);
	...
	public String[] threadNames(){
		return new String[] { "worker_2_","worker_6_","worker_7_","master","worker_4_","worker_5_","worker_3_","worker_0_","worker_1_" };
	}

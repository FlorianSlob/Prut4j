...
public class CGProtocol_strict_alt_n_8 implements IProtocol {
					...
					switch (state){
						...
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									...
									String[] receiverOptionsArray = new String[]{ "worker_5_","worker_7_","worker_2_","worker_3_","worker_4_","worker_0_","worker_1_","worker_6_" };
						...
						case 26:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(8);
									String[] receiverOptionsArray = new String[]{ "worker_3_","worker_6_","worker_7_","worker_1_","worker_2_","worker_0_","worker_4_","worker_5_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_3_")) {
									monitor.notifyAll();
						...
						case 37:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(8);
									String[] receiverOptionsArray = new String[]{ "worker_3_","worker_6_","worker_2_","worker_0_","worker_7_","worker_5_","worker_1_","worker_4_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_3_")) {
									monitor.notifyAll();
	...
	public String[] threadNames(){
		return new String[] { "worker_3_","worker_1_","worker_6_","worker_2_","worker_7_","master","worker_5_","worker_0_","worker_4_" };
	}

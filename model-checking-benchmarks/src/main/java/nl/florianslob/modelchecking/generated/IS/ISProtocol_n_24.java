...
public class ISProtocol_n_24 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 241){
								var result = exchange_200_241(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "worker_13_","worker_8_","worker_0_","worker_3_","worker_5_","worker_9_","worker_7_","worker_19_","worker_17_","worker_4_","worker_21_","worker_15_","worker_1_","worker_2_","master","worker_11_","worker_23_","worker_14_","worker_20_","worker_16_","worker_22_","worker_12_","worker_18_","worker_6_","worker_10_" };
	}

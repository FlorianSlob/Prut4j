...
public class ISProtocol_n_24 implements IProtocol {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_5(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 0 :
							...
							break;
						case 1:
							Any objectToGet = (Any)queueFrommasterToworker_22_.take();
							if (objectToGet.getClass() == discourje.examples.npb3.impl.ISThreads.RankMessage.class) {
								setState(3);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
				...
				public <Any, AnyInput> Optional<Any> exchange_0_5(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 0 :
							...
							break;
						case 1:
							Any objectToGet = (Any)queueFrommasterToworker_23_.take();
							if (objectToGet.getClass() == discourje.examples.npb3.impl.ISThreads.RankMessage.class) {
								setState(3);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
	...
	public String[] threadNames(){
		return new String[] { "worker_17_","worker_23_","worker_1_","worker_11_","worker_21_","worker_20_","worker_14_","worker_0_","master","worker_13_","worker_9_","worker_10_","worker_3_","worker_4_","worker_15_","worker_12_","worker_2_","worker_16_","worker_19_","worker_8_","worker_6_","worker_5_","worker_7_","worker_22_","worker_18_" };
	}

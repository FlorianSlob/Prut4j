...
public class FTProtocol_n_5 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 108){
								var result = exchange_0_108(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "evolve_3_","evolve_0_","master","evolve_4_","evolve_1_","fft_3_","fft_1_","evolve_2_","fft_4_","fft_2_","fft_0_" };
	}

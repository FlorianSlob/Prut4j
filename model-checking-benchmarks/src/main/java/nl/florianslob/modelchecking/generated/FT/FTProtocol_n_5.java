...
public class FTProtocol_n_5 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "evolve_0_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_108(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 0 :
						case 2 :
						case 3 :
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 108){
								Optional result = exchange_0_108(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "fft_3_","fft_2_","fft_4_","evolve_3_","fft_1_","master","evolve_0_","evolve_2_","evolve_4_","evolve_1_","fft_0_" };
	}

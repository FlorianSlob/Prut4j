...
public class CGProtocol_strict_alt_n_24 implements IProtocol {
					...
					switch (state){
						...
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									...
									String[] receiverOptionsArray = new String[]{ "worker_11_","worker_9_","worker_15_","worker_7_","worker_20_","worker_0_","worker_2_","worker_8_","worker_3_","worker_22_","worker_18_","worker_5_","worker_16_","worker_21_","worker_17_","worker_12_","worker_6_","worker_4_","worker_23_","worker_19_","worker_10_","worker_13_","worker_1_","worker_14_" };
						...
						case 74:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(24);
									String[] receiverOptionsArray = new String[]{ "worker_7_","worker_21_","worker_4_","worker_20_","worker_5_","worker_14_","worker_8_","worker_16_","worker_2_","worker_3_","worker_19_","worker_12_","worker_18_","worker_13_","worker_22_","worker_6_","worker_0_","worker_10_","worker_11_","worker_9_","worker_17_","worker_15_","worker_1_","worker_23_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_7_")) {
									monitor.notifyAll();
						...
						case 83:
							...
							break;
						case 84:
							if (!queueFromworker_19_Tomaster.isEmpty()) {
								monitor.notifyAll();
								setState(74);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
						...
						case 90:
							...
							break;
						case 91:
							if (!queueFromworker_23_Tomaster.isEmpty()) {
								monitor.notifyAll();
								setState(74);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
						...
						case 93:
							...
							break;
						case 94:
							if (!queueFromworker_22_Tomaster.isEmpty()) {
								monitor.notifyAll();
								setState(74);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
							...
							break;
						case 95:
							if (!queueFromworker_21_Tomaster.isEmpty()) {
								monitor.notifyAll();
								setState(74);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
						...
						case 96:
							...
							break;
						case 97:
							if (!queueFromworker_20_Tomaster.isEmpty()) {
								monitor.notifyAll();
								setState(74);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
						...
						case 101:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(24);
									String[] receiverOptionsArray = new String[]{ "worker_9_","worker_11_","worker_6_","worker_7_","worker_19_","worker_13_","worker_18_","worker_16_","worker_15_","worker_8_","worker_20_","worker_3_","worker_22_","worker_1_","worker_4_","worker_5_","worker_2_","worker_21_","worker_12_","worker_17_","worker_0_","worker_23_","worker_14_","worker_10_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_9_")) {
									monitor.notifyAll();
				...
				public <Any, AnyInput> Optional<Any> exchange_0_148(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 2:
							...
							break;
						case 27:
							if (!queueFrommasterToworker_19_.isEmpty()) {
								monitor.notifyAll();
								setState(146);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
				...
				public <Any, AnyInput> Optional<Any> exchange_0_148(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 2:
							...
							break;
						case 8:
							if (!queueFrommasterToworker_20_.isEmpty()) {
								monitor.notifyAll();
								setState(108);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
				...
				public <Any, AnyInput> Optional<Any> exchange_0_148(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 2:
							...
							break;
						case 11:
							if (!queueFrommasterToworker_21_.isEmpty()) {
								monitor.notifyAll();
								setState(114);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
				...
				public <Any, AnyInput> Optional<Any> exchange_0_148(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 2:
							...
							break;
						case 14:
							if (!queueFrommasterToworker_22_.isEmpty()) {
								monitor.notifyAll();
								setState(120);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
				...
				public <Any, AnyInput> Optional<Any> exchange_0_148(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 2:
							...
							break;
						case 17:
							if (!queueFrommasterToworker_23_.isEmpty()) {
								monitor.notifyAll();
								setState(126);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
	...
	public String[] threadNames(){
		return new String[] { "worker_19_","worker_12_","worker_13_","worker_23_","worker_3_","worker_18_","worker_8_","worker_4_","worker_17_","worker_9_","worker_5_","worker_14_","master","worker_10_","worker_2_","worker_7_","worker_15_","worker_1_","worker_22_","worker_20_","worker_21_","worker_16_","worker_11_","worker_0_","worker_6_" };
	}

...
public class CGProtocol_strict_n_27 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_200_271(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 201 :
						case 202 :
						case 205 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 271){
								var result = exchange_200_271(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "worker_19_","worker_10_","worker_23_","worker_12_","worker_3_","worker_22_","worker_21_","worker_8_","worker_13_","worker_9_","worker_11_","worker_2_","worker_16_","worker_15_","worker_4_","worker_25_","worker_20_","worker_7_","worker_18_","worker_6_","worker_0_","worker_24_","worker_26_","worker_5_","master","worker_17_","worker_14_","worker_1_" };
	}

...
public class CGProtocol_strict_alt_n_23 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_49(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(23);
									String[] receiverOptionsArray = new String[]{ "worker_21_","worker_5_","worker_15_","worker_8_","worker_13_","worker_19_","worker_10_","worker_18_","worker_9_","worker_0_","worker_6_","worker_12_","worker_2_","worker_17_","worker_4_","worker_14_","worker_11_","worker_7_","worker_20_","worker_16_","worker_22_","worker_3_","worker_1_" };
						...
						case 26:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(23);
									String[] receiverOptionsArray = new String[]{ "worker_3_","worker_19_","worker_6_","worker_4_","worker_10_","worker_11_","worker_12_","worker_7_","worker_22_","worker_14_","worker_13_","worker_18_","worker_21_","worker_17_","worker_15_","worker_9_","worker_5_","worker_20_","worker_0_","worker_1_","worker_2_","worker_16_","worker_8_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_3_")) {
									setState(36);
						...
						case 33:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(23);
									String[] receiverOptionsArray = new String[]{ "worker_5_","worker_6_","worker_10_","worker_12_","worker_20_","worker_18_","worker_7_","worker_11_","worker_4_","worker_3_","worker_8_","worker_14_","worker_21_","worker_19_","worker_0_","worker_22_","worker_2_","worker_13_","worker_17_","worker_9_","worker_16_","worker_1_","worker_15_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_5_")) {
									setState(41);
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					...
					while (true){
						if (state >=0 && state <= 49){
							Optional result = exchange_0_49(box, receiver, isCloseAction);
							if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_12_","worker_21_","worker_8_","worker_3_","worker_1_","worker_0_","worker_14_","master","worker_7_","worker_13_","worker_9_","worker_5_","worker_11_","worker_2_","worker_17_","worker_10_","worker_19_","worker_20_","worker_4_","worker_15_","worker_6_","worker_16_","worker_18_","worker_22_" };
	}

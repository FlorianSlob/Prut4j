...
public class CGProtocol_strict_n_20 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 201){
								var result = exchange_200_201(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "worker_7_","worker_19_","worker_4_","worker_13_","worker_12_","worker_16_","worker_1_","worker_10_","master","worker_18_","worker_9_","worker_3_","worker_2_","worker_14_","worker_6_","worker_0_","worker_15_","worker_8_","worker_5_","worker_11_","worker_17_" };
	}

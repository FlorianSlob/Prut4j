...
public class CGProtocol_strict_n_20 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_200_201(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 200 :
							monitor.wait();
							break;
					...
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 201){
								Optional result = exchange_200_201(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "worker_8_","worker_4_","worker_7_","worker_0_","worker_17_","worker_1_","worker_18_","worker_10_","worker_11_","worker_14_","worker_6_","worker_19_","worker_2_","worker_3_","worker_5_","worker_16_","worker_13_","worker_15_","master","worker_12_","worker_9_" };
	}

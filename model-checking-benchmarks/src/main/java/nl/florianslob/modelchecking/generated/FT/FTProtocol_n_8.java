...
public class FTProtocol_n_8 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 174){
								var result = exchange_0_174(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "fft_7_","fft_4_","fft_0_","evolve_4_","fft_2_","fft_1_","evolve_1_","fft_6_","fft_5_","evolve_2_","fft_3_","evolve_6_","evolve_5_","evolve_7_","master","evolve_0_","evolve_3_" };
	}

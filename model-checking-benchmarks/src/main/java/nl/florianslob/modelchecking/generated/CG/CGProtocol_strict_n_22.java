...
public class CGProtocol_strict_n_22 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 221){
								var result = exchange_200_221(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "worker_4_","worker_5_","worker_1_","master","worker_3_","worker_6_","worker_17_","worker_12_","worker_9_","worker_0_","worker_2_","worker_10_","worker_13_","worker_8_","worker_15_","worker_19_","worker_7_","worker_21_","worker_18_","worker_11_","worker_14_","worker_16_","worker_20_" };
	}

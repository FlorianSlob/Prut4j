...
public class CGProtocol_strict_n_22 implements IProtocol {
			...
			case "worker_21_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_5(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						...
						case 2:
							Any objectToGet = (Any)queueFrommasterToworker_21_.take();
							if (objectToGet.getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class) {
								setState(1);
								// Disabling unchecked inspection: We did check the class in the if statement above
								//noinspection unchecked
	...
	public String[] threadNames(){
		return new String[] { "worker_1_","worker_6_","worker_3_","worker_7_","worker_4_","worker_11_","worker_13_","worker_20_","master","worker_8_","worker_14_","worker_9_","worker_5_","worker_16_","worker_18_","worker_10_","worker_19_","worker_0_","worker_21_","worker_17_","worker_2_","worker_12_","worker_15_" };
	}

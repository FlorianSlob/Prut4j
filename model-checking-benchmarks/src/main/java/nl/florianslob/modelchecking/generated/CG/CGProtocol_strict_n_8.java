...
public class CGProtocol_strict_n_8 implements IProtocol {
			...
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 81){
								var result = exchange_0_81(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_0_","worker_5_","worker_2_","worker_3_","worker_7_","master","worker_1_","worker_4_","worker_6_" };
	}

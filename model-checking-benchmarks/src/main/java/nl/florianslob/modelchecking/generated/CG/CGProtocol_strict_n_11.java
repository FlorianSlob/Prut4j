...
public class CGProtocol_strict_n_11 implements IProtocol {
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 111){
								var result = exchange_0_111(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_1_","master","worker_3_","worker_5_","worker_7_","worker_8_","worker_6_","worker_0_","worker_2_","worker_4_","worker_10_","worker_9_" };
	}

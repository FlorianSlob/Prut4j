...
public class CGProtocol_strict_alt_n_16 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_35(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(16);
									String[] receiverOptionsArray = new String[]{ "worker_12_","worker_1_","worker_4_","worker_8_","worker_10_","worker_9_","worker_11_","worker_7_","worker_5_","worker_13_","worker_6_","worker_14_","worker_2_","worker_15_","worker_0_","worker_3_" };
						...
						case 3:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(16);
									String[] receiverOptionsArray = new String[]{ "worker_10_","worker_0_","worker_11_","worker_12_","worker_4_","worker_6_","worker_8_","worker_1_","worker_3_","worker_7_","worker_5_","worker_15_","worker_14_","worker_2_","worker_13_","worker_9_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_10_")) {
									setState(8);
						...
						case 18:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(16);
									String[] receiverOptionsArray = new String[]{ "worker_14_","worker_15_","worker_0_","worker_12_","worker_9_","worker_4_","worker_6_","worker_5_","worker_7_","worker_13_","worker_3_","worker_1_","worker_2_","worker_10_","worker_11_","worker_8_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_14_")) {
									setState(23);
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					...
					while (true){
						if (state >=0 && state <= 35){
							Optional result = exchange_0_35(box, receiver, isCloseAction);
							if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_4_","worker_7_","worker_0_","worker_6_","worker_11_","worker_9_","worker_10_","worker_12_","worker_5_","worker_1_","worker_13_","worker_3_","worker_14_","master","worker_2_","worker_15_","worker_8_" };
	}

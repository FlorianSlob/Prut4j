...
public class CGProtocol_strict_alt_n_16 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "master": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_0_100(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 1 :
						case 2 :
						case 4 :
						...
						case 0:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									...
									String[] receiverOptionsArray = new String[]{ "worker_9_","worker_7_","worker_15_","worker_10_","worker_13_","worker_5_","worker_6_","worker_11_","worker_4_","worker_8_","worker_14_","worker_2_","worker_12_","worker_1_","worker_0_","worker_3_" };
						...
						case 50:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(16);
									String[] receiverOptionsArray = new String[]{ "worker_14_","worker_9_","worker_3_","worker_13_","worker_15_","worker_1_","worker_10_","worker_4_","worker_8_","worker_6_","worker_5_","worker_11_","worker_0_","worker_2_","worker_12_","worker_7_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_14_")) {
									monitor.notifyAll();
						...
						case 69:
							if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
								if (receiver == null) {
									int rnd = new Random().nextInt(16);
									String[] receiverOptionsArray = new String[]{ "worker_6_","worker_8_","worker_9_","worker_0_","worker_14_","worker_7_","worker_15_","worker_1_","worker_12_","worker_11_","worker_5_","worker_10_","worker_2_","worker_13_","worker_4_","worker_3_" };
									receiver = receiverOptionsArray[rnd];
								}
								if (receiver.equals("worker_6_")) {
									monitor.notifyAll();
					...
					synchronized (monitor){
						while (true){
							if (state >=0 && state <= 100){
								Optional result = exchange_0_100(box, receiver, isCloseAction);
								if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_11_","worker_2_","worker_15_","worker_5_","worker_14_","master","worker_10_","worker_8_","worker_3_","worker_0_","worker_4_","worker_13_","worker_7_","worker_9_","worker_6_","worker_1_","worker_12_" };
	}

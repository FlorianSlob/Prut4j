...
public class FTProtocol_n_12 implements IProtocol {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			case "evolve_0_": return new IEnvironment() {
				...
				public <Any, AnyInput> Optional<Any> exchange_200_262(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					switch (state){
						case 200 :
						case 201 :
						case 202 :
				...
				public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
					synchronized (monitor){
						while (true){
							...
							if (state >=200 && state <= 262){
								Optional result = exchange_200_262(box, receiver, isCloseAction);
								if(result != null)
								  return (Optional<Any>) result;
							}
						}
	...
	public String[] threadNames(){
		return new String[] { "evolve_8_","fft_7_","evolve_5_","evolve_10_","fft_3_","evolve_6_","evolve_7_","evolve_4_","evolve_11_","evolve_3_","evolve_1_","fft_8_","fft_11_","fft_6_","fft_2_","evolve_2_","evolve_0_","fft_5_","fft_0_","master","fft_9_","fft_1_","evolve_9_","fft_10_","fft_4_" };
	}

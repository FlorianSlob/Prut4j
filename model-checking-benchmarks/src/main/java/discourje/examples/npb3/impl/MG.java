...
//--------------------------------------------------------------------
    ...
    for (int m = 0; m < num_threads; m++) {
        interp[m].in.send(new discourje.examples.npb3.impl.ExitMessage());
    ...
    for (int m = 0; m < num_threads; m++) {
        psinv[m].in.send(new discourje.examples.npb3.impl.ExitMessage());
        psinv[m].out.receive();
        while (true) {
            try {
                psinv[m].join();
    ...
    for (int m = 0; m < num_threads; m++) {
        rprj[m].in.send(new discourje.examples.npb3.impl.ExitMessage());
        rprj[m].out.receive();
        while (true) {
            try {
                rprj[m].join();
    ...
    for (int m = 0; m < num_threads; m++) {
        resid[m].in.send(new discourje.examples.npb3.impl.ExitMessage());
        resid[m].out.receive();
        while (true) {
            try {
                resid[m].join();

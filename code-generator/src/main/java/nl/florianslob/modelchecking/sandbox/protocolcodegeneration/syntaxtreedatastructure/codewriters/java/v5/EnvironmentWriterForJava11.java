...
//        StringBuilderSyntaxHelperForJava11.addCodeInBlock(builder,"case \""+syntaxTreeItem.roleName+"\": return new IEnvironment() {", "};", tabCount,
                StringBuilderSyntaxHelperForJava11.addCodeInBlock(builder,"private final IEnvironment "+syntaxTreeItem.roleName+"Environment = new IEnvironment() {", "};", tabCount,
            (tabCountLvl0) -> {
                ...
                StringBuilderSyntaxHelperForJava11.addMethod(builder,"public int getState()", tabCountLvl0,
                        (tabCountLvl1) -> {
                            StringBuilderSyntaxHelper.addLine(builder, tabCountLvl1, "return state;");
                        }
                );
                ...
                StringBuilderSyntaxHelperForJava11.addMethodOverride(builder,"public String getName()", tabCountLvl0,
                    (tabCountLvl1) -> {
                        StringBuilderSyntaxHelper.addLine(builder, tabCountLvl1, "return \""+syntaxTreeItem.roleName+"\";");
                    }
                );
                ...
                StringBuilderSyntaxHelperForJava11.addMethodOverride(builder,"public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception", tabCountLvl0,
                    (tabCountLvl1) -> {
                        for(int i = 0; i <= numberOfBlocks; i++) {
                            ...
                            StringBuilderSyntaxHelperForJava11.addScopedBlock(builder,"if (state >="+startIndex+" && state <= "+endIndex+")", tabCountLvl1,
                                    (tabCountLvl4) -> {
                        ...
                        StringBuilderSyntaxHelper.addLine(builder, tabCountLvl1, " throw new NotAllowedTransitionException();");

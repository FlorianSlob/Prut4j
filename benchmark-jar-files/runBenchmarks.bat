...
java -jar model-checking-benchmarks-v0.1.jar -runOriginalBenchmark -BM=FT -np24 class=B
java -jar model-checking-benchmarks-v0.1.jar -runUpdatedBenchmark  -BM=FT -np24 class=B

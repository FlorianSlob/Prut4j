...
import NPB.updated.NPB3_0_JAV.MG;
...
public class Resid extends MGBase {
    private final IEnvironment residEnvironment;
    public int id;
    public boolean visr;
    ...
    public Resid(MG mg, IEnvironment residEnvironment){
        Init(mg);
        u1=new double[nm+1];
        u2=new double[nm+1];
        ...
        setDaemon(true);
        master=mg;
        this.residEnvironment = residEnvironment;
    }
    void Init(MG mg){
...
//          }
            try {
                ...
                if (o instanceof ResidMessage) {
                    ...
                    GetWork();
                    step();
                    residEnvironment.send(new DoneMessage());
                }

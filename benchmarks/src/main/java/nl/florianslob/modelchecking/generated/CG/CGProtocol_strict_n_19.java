...
public class CGProtocol_strict_n_19 implements IProtocol {
	...
	private final IEnvironment masterEnvironment = new IEnvironment() {
		...
		public <Any, AnyInput> Optional<Any> exchange_0_24(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			switch (state){
				case 0:
				...
				case 1:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_13_","worker_10_","worker_11_","worker_6_","worker_9_","worker_5_","worker_16_","worker_18_","worker_1_","worker_2_","worker_12_","worker_3_","worker_17_","worker_7_","worker_0_","worker_15_","worker_14_","worker_4_","worker_8_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_13_")) {
							setState(16);
							worker_13_Queue.put(new ProtocolMessage(box.get(),51));
							return Optional.empty();
						}
						if (receiver.equals("worker_10_")) {
							setState(10);
							worker_10_Queue.put(new ProtocolMessage(box.get(),43));
							return Optional.empty();
						}
						if (receiver.equals("worker_11_")) {
							setState(12);
							worker_11_Queue.put(new ProtocolMessage(box.get(),46));
							return Optional.empty();
						}
						if (receiver.equals("worker_6_")) {
							setState(13);
							worker_6_Queue.put(new ProtocolMessage(box.get(),47));
							return Optional.empty();
						}
						if (receiver.equals("worker_9_")) {
							setState(19);
							worker_9_Queue.put(new ProtocolMessage(box.get(),54));
							return Optional.empty();
						}
						if (receiver.equals("worker_5_")) {
							setState(11);
							worker_5_Queue.put(new ProtocolMessage(box.get(),44));
							return Optional.empty();
						}
						if (receiver.equals("worker_16_")) {
							setState(0);
							worker_16_Queue.put(new ProtocolMessage(box.get(),56));
							return Optional.empty();
						}
						if (receiver.equals("worker_18_")) {
							setState(5);
							worker_18_Queue.put(new ProtocolMessage(box.get(),58));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_2_")) {
							setState(6);
							worker_2_Queue.put(new ProtocolMessage(box.get(),37));
							return Optional.empty();
						}
						if (receiver.equals("worker_12_")) {
							setState(14);
							worker_12_Queue.put(new ProtocolMessage(box.get(),48));
							return Optional.empty();
						}
						if (receiver.equals("worker_3_")) {
							setState(8);
							worker_3_Queue.put(new ProtocolMessage(box.get(),38));
							return Optional.empty();
						}
						if (receiver.equals("worker_17_")) {
							setState(4);
							worker_17_Queue.put(new ProtocolMessage(box.get(),57));
							return Optional.empty();
						}
						if (receiver.equals("worker_7_")) {
							setState(15);
							worker_7_Queue.put(new ProtocolMessage(box.get(),49));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_15_")) {
							setState(22);
							worker_15_Queue.put(new ProtocolMessage(box.get(),55));
							return Optional.empty();
						}
						if (receiver.equals("worker_14_")) {
							setState(18);
							worker_14_Queue.put(new ProtocolMessage(box.get(),53));
							return Optional.empty();
						}
						if (receiver.equals("worker_4_")) {
							setState(9);
							worker_4_Queue.put(new ProtocolMessage(box.get(),40));
							return Optional.empty();
						}
						if (receiver.equals("worker_8_")) {
							setState(17);
							worker_8_Queue.put(new ProtocolMessage(box.get(),52));
							return Optional.empty();
						}
					}
					if (isCloseAction) {
				...
				case 2:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(19);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_18_","worker_13_","worker_9_","worker_8_","worker_11_","worker_16_","worker_12_","worker_2_","worker_10_","worker_15_","worker_14_","worker_1_","worker_5_","worker_3_","worker_7_","worker_4_","worker_17_","worker_6_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(23);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(19);
							String[] receiverOptionsArray = new String[]{ "worker_18_","worker_3_","worker_5_","worker_14_","worker_8_","worker_9_","worker_13_","worker_11_","worker_0_","worker_1_","worker_15_","worker_12_","worker_2_","worker_17_","worker_4_","worker_7_","worker_6_","worker_16_","worker_10_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_18_")) {
							setState(21);
							worker_18_Queue.put(new ProtocolMessage(box.get(),30));
							return Optional.empty();
						}
						if (receiver.equals("worker_3_")) {
							setState(21);
						...
						if (receiver.equals("worker_17_")) {
							setState(21);
							worker_17_Queue.put(new ProtocolMessage(box.get(),29));
							return Optional.empty();
						}
						if (receiver.equals("worker_4_")) {
							setState(21);
				...
				case 20:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(19);
							String[] receiverOptionsArray = new String[]{ "worker_12_","worker_13_","worker_8_","worker_9_","worker_3_","worker_5_","worker_7_","worker_14_","worker_6_","worker_18_","worker_4_","worker_11_","worker_2_","worker_15_","worker_0_","worker_10_","worker_17_","worker_16_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_12_")) {
							setState(14);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(19);
							String[] receiverOptionsArray = new String[]{ "worker_2_","worker_9_","worker_17_","worker_4_","worker_16_","worker_0_","worker_12_","worker_14_","worker_11_","worker_8_","worker_1_","worker_15_","worker_6_","worker_7_","worker_3_","worker_13_","worker_18_","worker_10_","worker_5_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_2_")) {
							setState(21);
				...
				case 21:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(19);
							String[] receiverOptionsArray = new String[]{ "worker_18_","worker_10_","worker_4_","worker_6_","worker_13_","worker_11_","worker_12_","worker_2_","worker_7_","worker_8_","worker_3_","worker_14_","worker_0_","worker_17_","worker_1_","worker_16_","worker_15_","worker_9_","worker_5_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_18_")) {
							setState(5);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(19);
							String[] receiverOptionsArray = new String[]{ "worker_14_","worker_9_","worker_12_","worker_8_","worker_1_","worker_17_","worker_0_","worker_11_","worker_7_","worker_15_","worker_4_","worker_3_","worker_5_","worker_13_","worker_6_","worker_16_","worker_10_","worker_2_","worker_18_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_14_")) {
							setState(21);
		...
		public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			if (state >=0 && state <= 24){
				Optional result = exchange_0_24(box, receiver, isCloseAction);
				if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_12_","worker_14_","worker_1_","worker_13_","worker_8_","worker_16_","worker_5_","worker_17_","worker_3_","worker_4_","master","worker_7_","worker_6_","worker_9_","worker_0_","worker_2_","worker_10_","worker_18_","worker_15_","worker_11_" };
	}

...
public class MGProtocol_n_8 implements IProtocol {
			...
			switch (state){
				...
				case 3:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_1_")) {
							setState(4);
							rprj_1_Queue.put(new ProtocolMessage(box.get(),259));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 4:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_2_")) {
							setState(6);
							rprj_2_Queue.put(new ProtocolMessage(box.get(),261));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 6:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_3_")) {
							setState(8);
							rprj_3_Queue.put(new ProtocolMessage(box.get(),263));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 8:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_4_")) {
							setState(10);
							rprj_4_Queue.put(new ProtocolMessage(box.get(),265));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 10:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_5_")) {
							setState(12);
							rprj_5_Queue.put(new ProtocolMessage(box.get(),267));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 12:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_6_")) {
							setState(14);
							rprj_6_Queue.put(new ProtocolMessage(box.get(),269));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 14:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_7_")) {
							setState(16);
							rprj_7_Queue.put(new ProtocolMessage(box.get(),271));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 31:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_1_")) {
							setState(33);
							resid_1_Queue.put(new ProtocolMessage(box.get(),289));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 33:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_2_")) {
							setState(36);
							resid_2_Queue.put(new ProtocolMessage(box.get(),291));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 36:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_3_")) {
							setState(38);
							resid_3_Queue.put(new ProtocolMessage(box.get(),293));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 38:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_4_")) {
							setState(40);
							resid_4_Queue.put(new ProtocolMessage(box.get(),295));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 39:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_0_")) {
							setState(41);
							psinv_0_Queue.put(new ProtocolMessage(box.get(),40));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 40:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_5_")) {
							setState(42);
							resid_5_Queue.put(new ProtocolMessage(box.get(),297));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 42:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_6_")) {
							setState(44);
							resid_6_Queue.put(new ProtocolMessage(box.get(),299));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 43:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_0_")) {
							setState(45);
							rprj_0_Queue.put(new ProtocolMessage(box.get(),44));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 44:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_7_")) {
							setState(47);
							resid_7_Queue.put(new ProtocolMessage(box.get(),301));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 46:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_0_")) {
							setState(49);
							resid_0_Queue.put(new ProtocolMessage(box.get(),48));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 50:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_1_")) {
							setState(53);
							interpd_1_Queue.put(new ProtocolMessage(box.get(),52));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 54:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_1_")) {
							setState(57);
							psinv_1_Queue.put(new ProtocolMessage(box.get(),56));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 58:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_1_")) {
							setState(61);
							rprj_1_Queue.put(new ProtocolMessage(box.get(),60));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 62:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_1_")) {
							setState(63);
							resid_1_Queue.put(new ProtocolMessage(box.get(),64));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 64:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_2_")) {
							setState(65);
							interpd_2_Queue.put(new ProtocolMessage(box.get(),68));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 66:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_2_")) {
							setState(67);
							psinv_2_Queue.put(new ProtocolMessage(box.get(),72));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 68:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_2_")) {
							setState(69);
							rprj_2_Queue.put(new ProtocolMessage(box.get(),76));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 70:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_2_")) {
							setState(71);
							resid_2_Queue.put(new ProtocolMessage(box.get(),80));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 72:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_3_")) {
							setState(73);
							interpd_3_Queue.put(new ProtocolMessage(box.get(),84));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 74:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_3_")) {
							setState(75);
							psinv_3_Queue.put(new ProtocolMessage(box.get(),88));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 76:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_3_")) {
							setState(77);
							rprj_3_Queue.put(new ProtocolMessage(box.get(),92));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 78:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_3_")) {
							setState(79);
							resid_3_Queue.put(new ProtocolMessage(box.get(),96));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 80:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_4_")) {
							setState(81);
							interpd_4_Queue.put(new ProtocolMessage(box.get(),100));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 82:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_4_")) {
							setState(83);
							psinv_4_Queue.put(new ProtocolMessage(box.get(),104));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 84:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_4_")) {
							setState(85);
							rprj_4_Queue.put(new ProtocolMessage(box.get(),108));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 86:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_4_")) {
							setState(87);
							resid_4_Queue.put(new ProtocolMessage(box.get(),112));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 88:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_5_")) {
							setState(89);
							interpd_5_Queue.put(new ProtocolMessage(box.get(),116));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 90:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_5_")) {
							setState(91);
							psinv_5_Queue.put(new ProtocolMessage(box.get(),120));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 92:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_5_")) {
							setState(93);
							rprj_5_Queue.put(new ProtocolMessage(box.get(),124));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 94:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_5_")) {
							setState(95);
							resid_5_Queue.put(new ProtocolMessage(box.get(),128));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 96:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_6_")) {
							setState(97);
							interpd_6_Queue.put(new ProtocolMessage(box.get(),132));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 98:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_6_")) {
							setState(99);
							psinv_6_Queue.put(new ProtocolMessage(box.get(),136));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 100:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_6_")) {
							setState(101);
							rprj_6_Queue.put(new ProtocolMessage(box.get(),140));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 102:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_6_")) {
							setState(103);
							resid_6_Queue.put(new ProtocolMessage(box.get(),144));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 104:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_7_")) {
							setState(105);
							interpd_7_Queue.put(new ProtocolMessage(box.get(),148));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 106:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_7_")) {
							setState(107);
							psinv_7_Queue.put(new ProtocolMessage(box.get(),152));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 108:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_7_")) {
							setState(109);
							rprj_7_Queue.put(new ProtocolMessage(box.get(),156));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 110:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_7_")) {
							setState(111);
							resid_7_Queue.put(new ProtocolMessage(box.get(),160));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 144:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_1_")) {
							setState(145);
							psinv_1_Queue.put(new ProtocolMessage(box.get(),229));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 145:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_2_")) {
							setState(146);
							psinv_2_Queue.put(new ProtocolMessage(box.get(),231));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 146:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_3_")) {
							setState(147);
							psinv_3_Queue.put(new ProtocolMessage(box.get(),233));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 147:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_4_")) {
							setState(148);
							psinv_4_Queue.put(new ProtocolMessage(box.get(),235));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 148:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_5_")) {
							setState(149);
							psinv_5_Queue.put(new ProtocolMessage(box.get(),237));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 149:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_6_")) {
							setState(150);
							psinv_6_Queue.put(new ProtocolMessage(box.get(),239));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 150:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_7_")) {
							setState(151);
							psinv_7_Queue.put(new ProtocolMessage(box.get(),241));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
			...
			switch (state){
				...
				case 4:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
						...
						if (receiver.equals("master")) {
							setState(2);
							masterQueue.put(new ProtocolMessage(box.get(),255));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
	...
	public String[] threadNames(){
		return new String[] { "resid_7_","master","resid_5_","resid_6_","rprj_6_","interpd_1_","rprj_1_","interpd_5_","psinv_0_","rprj_3_","psinv_3_","interpd_0_","interpd_3_","resid_4_","psinv_4_","rprj_0_","resid_1_","psinv_2_","interpd_6_","resid_2_","psinv_7_","rprj_4_","psinv_5_","rprj_2_","resid_3_","resid_0_","interpd_4_","rprj_5_","psinv_6_","interpd_2_","psinv_1_","interpd_7_","rprj_7_" };
	}
	...
	public String getState(){
		return "/" + interpd_0_Environment.getState() + "/" + interpd_1_Environment.getState() + "/" + interpd_2_Environment.getState() + "/" + interpd_3_Environment.getState() + "/" + interpd_4_Environment.getState() + "/" + interpd_5_Environment.getState() + "/" + interpd_6_Environment.getState() + "/" + interpd_7_Environment.getState() + "/" + masterEnvironment.getState() + "/" + psinv_0_Environment.getState() + "/" + psinv_1_Environment.getState() + "/" + psinv_2_Environment.getState() + "/" + psinv_3_Environment.getState() + "/" + psinv_4_Environment.getState() + "/" + psinv_5_Environment.getState() + "/" + psinv_6_Environment.getState() + "/" + psinv_7_Environment.getState() + "/" + resid_0_Environment.getState() + "/" + resid_1_Environment.getState() + "/" + resid_2_Environment.getState() + "/" + resid_3_Environment.getState() + "/" + resid_4_Environment.getState() + "/" + resid_5_Environment.getState() + "/" + resid_6_Environment.getState() + "/" + resid_7_Environment.getState() + "/" + rprj_0_Environment.getState() + "/" + rprj_1_Environment.getState() + "/" + rprj_2_Environment.getState() + "/" + rprj_3_Environment.getState() + "/" + rprj_4_Environment.getState() + "/" + rprj_5_Environment.getState() + "/" + rprj_6_Environment.getState() + "/" + rprj_7_Environment.getState() + "/";
	}
}

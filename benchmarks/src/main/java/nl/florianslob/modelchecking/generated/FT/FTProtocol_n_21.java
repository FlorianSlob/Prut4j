...
public class FTProtocol_n_21 implements IProtocol {
			...
			switch (state){
				...
				case 4:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
						...
						if (receiver.equals("master")) {
							setState(1);
							masterQueue.put(new ProtocolMessage(box.get(),384));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
			...
			switch (state){
				...
				case 3:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
						...
						if (receiver.equals("master")) {
							setState(1);
							masterQueue.put(new ProtocolMessage(box.get(),388));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
	...
	private final IEnvironment masterEnvironment = new IEnvironment() {
			...
			switch (state){
				...
				case 45:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_0_")) {
							setState(46);
							fft_0_Queue.put(new ProtocolMessage(box.get(),91));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 47:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_1_")) {
							setState(48);
							evolve_1_Queue.put(new ProtocolMessage(box.get(),95));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 49:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_1_")) {
							setState(50);
							fft_1_Queue.put(new ProtocolMessage(box.get(),99));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 51:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_2_")) {
							setState(52);
							evolve_2_Queue.put(new ProtocolMessage(box.get(),103));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 53:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_2_")) {
							setState(54);
							fft_2_Queue.put(new ProtocolMessage(box.get(),107));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 55:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_3_")) {
							setState(56);
							evolve_3_Queue.put(new ProtocolMessage(box.get(),111));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 57:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_3_")) {
							setState(58);
							fft_3_Queue.put(new ProtocolMessage(box.get(),115));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 59:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_4_")) {
							setState(60);
							evolve_4_Queue.put(new ProtocolMessage(box.get(),119));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 61:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_4_")) {
							setState(62);
							fft_4_Queue.put(new ProtocolMessage(box.get(),123));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 63:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_5_")) {
							setState(64);
							evolve_5_Queue.put(new ProtocolMessage(box.get(),127));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 65:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_5_")) {
							setState(66);
							fft_5_Queue.put(new ProtocolMessage(box.get(),131));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 67:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_6_")) {
							setState(68);
							evolve_6_Queue.put(new ProtocolMessage(box.get(),135));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 69:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_6_")) {
							setState(70);
							fft_6_Queue.put(new ProtocolMessage(box.get(),139));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 71:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_7_")) {
							setState(72);
							evolve_7_Queue.put(new ProtocolMessage(box.get(),143));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 73:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_7_")) {
							setState(74);
							fft_7_Queue.put(new ProtocolMessage(box.get(),147));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 75:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_8_")) {
							setState(76);
							evolve_8_Queue.put(new ProtocolMessage(box.get(),151));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 77:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_8_")) {
							setState(78);
							fft_8_Queue.put(new ProtocolMessage(box.get(),155));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 79:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_9_")) {
							setState(80);
							evolve_9_Queue.put(new ProtocolMessage(box.get(),159));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 81:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_9_")) {
							setState(82);
							fft_9_Queue.put(new ProtocolMessage(box.get(),163));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 83:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_10_")) {
							setState(84);
							evolve_10_Queue.put(new ProtocolMessage(box.get(),167));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 85:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_10_")) {
							setState(86);
							fft_10_Queue.put(new ProtocolMessage(box.get(),171));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 87:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_11_")) {
							setState(88);
							evolve_11_Queue.put(new ProtocolMessage(box.get(),175));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 89:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_11_")) {
							setState(90);
							fft_11_Queue.put(new ProtocolMessage(box.get(),179));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 91:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_12_")) {
							setState(92);
							evolve_12_Queue.put(new ProtocolMessage(box.get(),183));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 93:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_12_")) {
							setState(94);
							fft_12_Queue.put(new ProtocolMessage(box.get(),187));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 95:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_13_")) {
							setState(96);
							evolve_13_Queue.put(new ProtocolMessage(box.get(),191));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 97:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_13_")) {
							setState(98);
							fft_13_Queue.put(new ProtocolMessage(box.get(),195));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 99:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_14_")) {
							setState(100);
							evolve_14_Queue.put(new ProtocolMessage(box.get(),199));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 101:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_14_")) {
							setState(102);
							fft_14_Queue.put(new ProtocolMessage(box.get(),203));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 103:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_15_")) {
							setState(104);
							evolve_15_Queue.put(new ProtocolMessage(box.get(),207));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 105:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_15_")) {
							setState(106);
							fft_15_Queue.put(new ProtocolMessage(box.get(),211));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 107:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_16_")) {
							setState(108);
							evolve_16_Queue.put(new ProtocolMessage(box.get(),215));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 109:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_16_")) {
							setState(110);
							fft_16_Queue.put(new ProtocolMessage(box.get(),219));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 111:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_17_")) {
							setState(112);
							evolve_17_Queue.put(new ProtocolMessage(box.get(),223));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 113:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_17_")) {
							setState(114);
							fft_17_Queue.put(new ProtocolMessage(box.get(),227));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 115:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_18_")) {
							setState(116);
							evolve_18_Queue.put(new ProtocolMessage(box.get(),231));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 117:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_18_")) {
							setState(118);
							fft_18_Queue.put(new ProtocolMessage(box.get(),235));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 119:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_19_")) {
							setState(120);
							evolve_19_Queue.put(new ProtocolMessage(box.get(),239));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 121:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_19_")) {
							setState(122);
							fft_19_Queue.put(new ProtocolMessage(box.get(),243));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 123:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("evolve_20_")) {
							setState(124);
							evolve_20_Queue.put(new ProtocolMessage(box.get(),247));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 125:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("fft_20_")) {
							setState(126);
							fft_20_Queue.put(new ProtocolMessage(box.get(),251));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 169:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_1_")) {
							setState(170);
							fft_1_Queue.put(new ProtocolMessage(box.get(),340));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 170:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_2_")) {
							setState(171);
							fft_2_Queue.put(new ProtocolMessage(box.get(),342));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 171:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_3_")) {
							setState(172);
							fft_3_Queue.put(new ProtocolMessage(box.get(),344));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 172:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_4_")) {
							setState(173);
							fft_4_Queue.put(new ProtocolMessage(box.get(),346));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 173:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_5_")) {
							setState(174);
							fft_5_Queue.put(new ProtocolMessage(box.get(),348));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 174:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_6_")) {
							setState(175);
							fft_6_Queue.put(new ProtocolMessage(box.get(),350));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 175:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_7_")) {
							setState(176);
							fft_7_Queue.put(new ProtocolMessage(box.get(),352));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 176:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_8_")) {
							setState(177);
							fft_8_Queue.put(new ProtocolMessage(box.get(),354));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 177:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_9_")) {
							setState(178);
							fft_9_Queue.put(new ProtocolMessage(box.get(),356));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 178:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_10_")) {
							setState(179);
							fft_10_Queue.put(new ProtocolMessage(box.get(),358));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 179:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_11_")) {
							setState(180);
							fft_11_Queue.put(new ProtocolMessage(box.get(),360));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 180:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_12_")) {
							setState(181);
							fft_12_Queue.put(new ProtocolMessage(box.get(),362));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 181:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_13_")) {
							setState(182);
							fft_13_Queue.put(new ProtocolMessage(box.get(),364));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 182:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_14_")) {
							setState(183);
							fft_14_Queue.put(new ProtocolMessage(box.get(),366));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 183:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_15_")) {
							setState(184);
							fft_15_Queue.put(new ProtocolMessage(box.get(),368));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 184:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_16_")) {
							setState(185);
							fft_16_Queue.put(new ProtocolMessage(box.get(),370));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 185:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_17_")) {
							setState(186);
							fft_17_Queue.put(new ProtocolMessage(box.get(),372));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 186:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_18_")) {
							setState(187);
							fft_18_Queue.put(new ProtocolMessage(box.get(),374));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 187:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_19_")) {
							setState(188);
							fft_19_Queue.put(new ProtocolMessage(box.get(),376));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 188:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTMessage.class ) {
						...
						if (receiver.equals("fft_20_")) {
							setState(189);
							fft_20_Queue.put(new ProtocolMessage(box.get(),378));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
		...
		public <Any, AnyInput> Optional<Any> exchange_200_230(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			switch (state){
				case 200:
					if(!box.isPresent() && !isCloseAction){
						setState(201);
				...
				case 210:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_1_")) {
							setState(211);
							fft_1_Queue.put(new ProtocolMessage(box.get(),422));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 211:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_2_")) {
							setState(212);
							fft_2_Queue.put(new ProtocolMessage(box.get(),424));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 212:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_3_")) {
							setState(213);
							fft_3_Queue.put(new ProtocolMessage(box.get(),426));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 213:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_4_")) {
							setState(214);
							fft_4_Queue.put(new ProtocolMessage(box.get(),428));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 214:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_5_")) {
							setState(215);
							fft_5_Queue.put(new ProtocolMessage(box.get(),430));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 215:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_6_")) {
							setState(216);
							fft_6_Queue.put(new ProtocolMessage(box.get(),432));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 216:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_7_")) {
							setState(217);
							fft_7_Queue.put(new ProtocolMessage(box.get(),434));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 217:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_8_")) {
							setState(218);
							fft_8_Queue.put(new ProtocolMessage(box.get(),436));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 218:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_9_")) {
							setState(219);
							fft_9_Queue.put(new ProtocolMessage(box.get(),438));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 219:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_10_")) {
							setState(220);
							fft_10_Queue.put(new ProtocolMessage(box.get(),440));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 220:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_11_")) {
							setState(221);
							fft_11_Queue.put(new ProtocolMessage(box.get(),442));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 221:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_12_")) {
							setState(222);
							fft_12_Queue.put(new ProtocolMessage(box.get(),444));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 222:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_13_")) {
							setState(223);
							fft_13_Queue.put(new ProtocolMessage(box.get(),446));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 223:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_14_")) {
							setState(224);
							fft_14_Queue.put(new ProtocolMessage(box.get(),448));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 224:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_15_")) {
							setState(225);
							fft_15_Queue.put(new ProtocolMessage(box.get(),450));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 225:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_16_")) {
							setState(226);
							fft_16_Queue.put(new ProtocolMessage(box.get(),452));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 226:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_17_")) {
							setState(227);
							fft_17_Queue.put(new ProtocolMessage(box.get(),454));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 227:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_18_")) {
							setState(228);
							fft_18_Queue.put(new ProtocolMessage(box.get(),456));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 228:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.class ) {
						...
						if (receiver.equals("fft_19_")) {
							setState(229);
							fft_19_Queue.put(new ProtocolMessage(box.get(),458));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
		...
		public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			...
			if (state >=200 && state <= 230){
				Optional result = exchange_200_230(box, receiver, isCloseAction);
				if(result != null)
				  return (Optional<Any>) result;
			}
			 throw new NotAllowedTransitionException();
	...
	public String[] threadNames(){
		return new String[] { "fft_2_","evolve_3_","fft_14_","fft_11_","fft_16_","evolve_6_","evolve_14_","evolve_12_","evolve_13_","evolve_4_","fft_10_","evolve_19_","fft_17_","fft_0_","evolve_15_","fft_7_","evolve_7_","fft_13_","evolve_0_","fft_4_","evolve_20_","evolve_1_","evolve_16_","evolve_9_","fft_6_","fft_12_","fft_15_","fft_19_","evolve_18_","fft_5_","evolve_10_","fft_8_","fft_20_","fft_1_","evolve_2_","evolve_5_","fft_18_","evolve_8_","fft_9_","evolve_11_","evolve_17_","master","fft_3_" };
	}
	
	@Override
	public Object[] dummies(){
		return new Object[]{discourje.examples.npb3.impl.FTThreads.EvolveMessage.GetTestDummyObject(),discourje.examples.npb3.impl.FTThreads.FFTMessage.GetTestDummyObject(),discourje.examples.npb3.impl.DoneMessage.GetTestDummyObject(),discourje.examples.npb3.impl.FTThreads.FFTSetVariablesMessage.GetTestDummyObject(),discourje.examples.npb3.impl.ExitMessage.GetTestDummyObject()};
	}
	
	@Override
	public String getState(){
		return "/" + evolve_0_Environment.getState() + "/" + evolve_10_Environment.getState() + "/" + evolve_11_Environment.getState() + "/" + evolve_12_Environment.getState() + "/" + evolve_13_Environment.getState() + "/" + evolve_14_Environment.getState() + "/" + evolve_15_Environment.getState() + "/" + evolve_16_Environment.getState() + "/" + evolve_17_Environment.getState() + "/" + evolve_18_Environment.getState() + "/" + evolve_19_Environment.getState() + "/" + evolve_1_Environment.getState() + "/" + evolve_20_Environment.getState() + "/" + evolve_2_Environment.getState() + "/" + evolve_3_Environment.getState() + "/" + evolve_4_Environment.getState() + "/" + evolve_5_Environment.getState() + "/" + evolve_6_Environment.getState() + "/" + evolve_7_Environment.getState() + "/" + evolve_8_Environment.getState() + "/" + evolve_9_Environment.getState() + "/" + fft_0_Environment.getState() + "/" + fft_10_Environment.getState() + "/" + fft_11_Environment.getState() + "/" + fft_12_Environment.getState() + "/" + fft_13_Environment.getState() + "/" + fft_14_Environment.getState() + "/" + fft_15_Environment.getState() + "/" + fft_16_Environment.getState() + "/" + fft_17_Environment.getState() + "/" + fft_18_Environment.getState() + "/" + fft_19_Environment.getState() + "/" + fft_1_Environment.getState() + "/" + fft_20_Environment.getState() + "/" + fft_2_Environment.getState() + "/" + fft_3_Environment.getState() + "/" + fft_4_Environment.getState() + "/" + fft_5_Environment.getState() + "/" + fft_6_Environment.getState() + "/" + fft_7_Environment.getState() + "/" + fft_8_Environment.getState() + "/" + fft_9_Environment.getState() + "/" + masterEnvironment.getState() + "/";
	}
}

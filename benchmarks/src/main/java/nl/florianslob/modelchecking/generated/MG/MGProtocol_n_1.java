...
public class MGProtocol_n_1 implements Pr {
			...
			switch (state){
				...
				case 8:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_0_")) {
							setState(9);
							psinv_0_Queue.put(new ProtocolMessage(box.get(),12));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 10:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_0_")) {
							setState(11);
							rprj_0_Queue.put(new ProtocolMessage(box.get(),16));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 12:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_0_")) {
							setState(13);
							resid_0_Queue.put(new ProtocolMessage(box.get(),20));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
	...
	public String[] threadNames(){
		return new String[] { "rprj_0_","master","resid_0_","interp_0_","psinv_0_" };
	}
	
	@Override
	public String getState(){
		return "/" + interp_0_Environment.getState() + "/" + masterEnvironment.getState() + "/" + psinv_0_Environment.getState() + "/" + resid_0_Environment.getState() + "/" + rprj_0_Environment.getState() + "/";
	}

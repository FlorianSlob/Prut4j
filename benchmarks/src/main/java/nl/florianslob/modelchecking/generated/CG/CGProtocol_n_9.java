...
public class CGProtocol_n_9 implements IProtocol {
	...
	public String[] threadNames(){
		return new String[] { "worker_3_","worker_1_","worker_2_","worker_6_","worker_0_","worker_7_","worker_5_","master","worker_8_","worker_4_" };
	}

...
public class CGProtocol_n_10 implements Pr {
	...
	public String[] threadNames(){
		return new String[] { "worker_6_","worker_7_","worker_4_","worker_3_","master","worker_2_","worker_9_","worker_0_","worker_8_","worker_1_","worker_5_" };
	}

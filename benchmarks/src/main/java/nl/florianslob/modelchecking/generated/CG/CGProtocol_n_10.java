...
public class CGProtocol_n_10 implements IProtocol {
	...
	public String[] threadNames(){
		return new String[] { "worker_9_","worker_3_","worker_7_","worker_5_","worker_2_","master","worker_1_","worker_4_","worker_0_","worker_6_","worker_8_" };
	}

...
public class CGProtocol_strict_n_7 implements IProtocol {
	...
	private final IEnvironment masterEnvironment = new IEnvironment() {
			...
			switch (state){
				...
				case 5:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_5_","worker_4_","worker_2_","worker_0_","worker_1_","worker_3_","worker_6_" };
						...
						if (receiver.equals("worker_4_")) {
							setState(5);
							worker_4_Queue.put(new ProtocolMessage(box.get(),9));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_1_")) {
							setState(5);
							worker_1_Queue.put(new ProtocolMessage(box.get(),3));
							return Optional.empty();
						}
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(7);
							String[] receiverOptionsArray = new String[]{ "worker_6_","worker_4_","worker_2_","worker_5_","worker_1_","worker_3_","worker_0_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_6_")) {
							setState(4);
						...
						if (receiver.equals("worker_4_")) {
							setState(1);
							worker_4_Queue.put(new ProtocolMessage(box.get(),20));
							return Optional.empty();
						}
						if (receiver.equals("worker_2_")) {
							setState(11);
						...
						if (receiver.equals("worker_3_")) {
							setState(0);
							worker_3_Queue.put(new ProtocolMessage(box.get(),19));
							return Optional.empty();
						}
						if (receiver.equals("worker_0_")) {
							setState(7);
							worker_0_Queue.put(new ProtocolMessage(box.get(),16));
							return Optional.empty();
						}
					}
					if (isCloseAction) {
				...
				case 6:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(7);
							String[] receiverOptionsArray = new String[]{ "worker_5_","worker_6_","worker_0_","worker_3_","worker_2_","worker_4_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_5_")) {
							setState(5);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(7);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_6_","worker_5_","worker_3_","worker_2_","worker_4_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(7);
				...
				case 8:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(7);
							String[] receiverOptionsArray = new String[]{ "worker_4_","worker_3_","worker_5_","worker_0_","worker_2_","worker_6_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_4_")) {
							setState(1);
				...
				case 10:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(7);
							String[] receiverOptionsArray = new String[]{ "worker_1_","worker_6_","worker_3_","worker_5_","worker_2_","worker_0_","worker_4_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_1_")) {
							setState(9);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(7);
							String[] receiverOptionsArray = new String[]{ "worker_2_","worker_4_","worker_3_","worker_5_","worker_6_","worker_0_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_2_")) {
							setState(5);
		...
		public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			if (state >=0 && state <= 12){
				Optional result = exchange_0_12(box, receiver, isCloseAction);
				if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_3_","worker_4_","worker_0_","worker_5_","worker_1_","worker_6_","master","worker_2_" };
	}
	
	@Override
	public String getState(){
		return "/" + masterEnvironment.getState() + "/" + worker_0_Environment.getState() + "/" + worker_1_Environment.getState() + "/" + worker_2_Environment.getState() + "/" + worker_3_Environment.getState() + "/" + worker_4_Environment.getState() + "/" + worker_5_Environment.getState() + "/" + worker_6_Environment.getState() + "/";
	}
}

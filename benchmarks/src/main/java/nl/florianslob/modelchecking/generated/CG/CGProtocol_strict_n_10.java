...
public class CGProtocol_strict_n_10 implements IProtocol {
	...
	private final IEnvironment masterEnvironment = new IEnvironment() {
		...
		public <Any, AnyInput> Optional<Any> exchange_0_15(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			switch (state){
				case 0:
				...
				case 1:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_3_","worker_9_","worker_0_","worker_2_","worker_6_","worker_8_","worker_5_","worker_7_","worker_1_","worker_4_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_3_")) {
							setState(5);
							worker_3_Queue.put(new ProtocolMessage(box.get(),24));
						...
						if (receiver.equals("worker_6_")) {
							setState(9);
							worker_6_Queue.put(new ProtocolMessage(box.get(),27));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_5_")) {
							setState(7);
							worker_5_Queue.put(new ProtocolMessage(box.get(),26));
							return Optional.empty();
						}
						if (receiver.equals("worker_7_")) {
							setState(12);
							worker_7_Queue.put(new ProtocolMessage(box.get(),29));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_4_")) {
							setState(6);
							worker_4_Queue.put(new ProtocolMessage(box.get(),25));
							return Optional.empty();
						}
					}
					if (isCloseAction) {
				...
				case 8:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(10);
							String[] receiverOptionsArray = new String[]{ "worker_4_","worker_9_","worker_7_","worker_0_","worker_1_","worker_2_","worker_8_","worker_3_","worker_5_","worker_6_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_4_")) {
							setState(11);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(10);
							String[] receiverOptionsArray = new String[]{ "worker_4_","worker_2_","worker_6_","worker_3_","worker_8_","worker_1_","worker_7_","worker_9_","worker_0_","worker_5_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_4_")) {
							setState(6);
				...
				case 10:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(10);
							String[] receiverOptionsArray = new String[]{ "worker_8_","worker_0_","worker_5_","worker_2_","worker_9_","worker_6_","worker_4_","worker_1_","worker_7_","worker_3_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_8_")) {
							setState(13);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(10);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_6_","worker_3_","worker_4_","worker_1_","worker_8_","worker_9_","worker_5_","worker_7_","worker_2_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(11);
				...
				case 11:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(10);
							String[] receiverOptionsArray = new String[]{ "worker_8_","worker_6_","worker_1_","worker_2_","worker_3_","worker_9_","worker_5_","worker_0_","worker_4_","worker_7_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_8_")) {
							setState(13);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(10);
							String[] receiverOptionsArray = new String[]{ "worker_2_","worker_4_","worker_1_","worker_9_","worker_0_","worker_3_","worker_7_","worker_5_","worker_6_","worker_8_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_2_")) {
							setState(11);
		...
		public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			if (state >=0 && state <= 15){
				Optional result = exchange_0_15(box, receiver, isCloseAction);
				if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_5_","worker_6_","worker_9_","master","worker_2_","worker_0_","worker_4_","worker_1_","worker_7_","worker_3_","worker_8_" };
	}

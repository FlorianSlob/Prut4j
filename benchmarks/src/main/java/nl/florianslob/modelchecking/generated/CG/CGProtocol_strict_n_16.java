...
public class CGProtocol_strict_n_16 implements IProtocol {
			...
			switch (state){
				...
				case 4:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_6_","worker_8_","worker_4_","worker_12_","worker_15_","worker_3_","worker_10_","worker_1_","worker_11_","worker_9_","worker_14_","worker_0_","worker_5_","worker_13_","worker_2_","worker_7_" };
						...
						if (receiver.equals("worker_9_")) {
							setState(5);
							worker_9_Queue.put(new ProtocolMessage(box.get(),27));
							return Optional.empty();
						}
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(16);
							String[] receiverOptionsArray = new String[]{ "worker_8_","worker_12_","worker_10_","worker_0_","worker_14_","worker_7_","worker_11_","worker_5_","worker_3_","worker_9_","worker_4_","worker_15_","worker_13_","worker_6_","worker_2_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_8_")) {
							setState(10);
							worker_8_Queue.put(new ProtocolMessage(box.get(),46));
							return Optional.empty();
						}
						if (receiver.equals("worker_12_")) {
							setState(7);
							worker_12_Queue.put(new ProtocolMessage(box.get(),42));
							return Optional.empty();
						}
						if (receiver.equals("worker_10_")) {
							setState(0);
							worker_10_Queue.put(new ProtocolMessage(box.get(),37));
							return Optional.empty();
						}
						if (receiver.equals("worker_0_")) {
							setState(15);
							worker_0_Queue.put(new ProtocolMessage(box.get(),28));
							return Optional.empty();
						}
						if (receiver.equals("worker_14_")) {
							setState(11);
							worker_14_Queue.put(new ProtocolMessage(box.get(),47));
							return Optional.empty();
						}
						if (receiver.equals("worker_7_")) {
							setState(8);
							worker_7_Queue.put(new ProtocolMessage(box.get(),43));
							return Optional.empty();
						}
						if (receiver.equals("worker_11_")) {
							setState(3);
							worker_11_Queue.put(new ProtocolMessage(box.get(),40));
							return Optional.empty();
						}
						if (receiver.equals("worker_5_")) {
							setState(1);
							worker_5_Queue.put(new ProtocolMessage(box.get(),38));
							return Optional.empty();
						}
						if (receiver.equals("worker_3_")) {
							setState(19);
							worker_3_Queue.put(new ProtocolMessage(box.get(),32));
							return Optional.empty();
						}
						if (receiver.equals("worker_9_")) {
							setState(13);
							worker_9_Queue.put(new ProtocolMessage(box.get(),48));
							return Optional.empty();
						}
						if (receiver.equals("worker_4_")) {
							setState(20);
							worker_4_Queue.put(new ProtocolMessage(box.get(),34));
							return Optional.empty();
						}
						if (receiver.equals("worker_15_")) {
							setState(14);
							worker_15_Queue.put(new ProtocolMessage(box.get(),49));
							return Optional.empty();
						}
						if (receiver.equals("worker_13_")) {
							setState(9);
							worker_13_Queue.put(new ProtocolMessage(box.get(),45));
							return Optional.empty();
						}
						if (receiver.equals("worker_6_")) {
							setState(6);
							worker_6_Queue.put(new ProtocolMessage(box.get(),41));
							return Optional.empty();
						}
						if (receiver.equals("worker_2_")) {
							setState(18);
							worker_2_Queue.put(new ProtocolMessage(box.get(),31));
							return Optional.empty();
						}
						if (receiver.equals("worker_1_")) {
							setState(17);
				...
				case 5:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(16);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_10_","worker_3_","worker_5_","worker_7_","worker_6_","worker_13_","worker_1_","worker_12_","worker_2_","worker_4_","worker_11_","worker_15_","worker_9_","worker_14_","worker_8_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(5);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(16);
							String[] receiverOptionsArray = new String[]{ "worker_1_","worker_2_","worker_3_","worker_15_","worker_0_","worker_12_","worker_9_","worker_13_","worker_5_","worker_6_","worker_8_","worker_7_","worker_10_","worker_4_","worker_11_","worker_14_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_1_")) {
							setState(17);
				...
				case 12:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(16);
							String[] receiverOptionsArray = new String[]{ "worker_15_","worker_3_","worker_9_","worker_12_","worker_1_","worker_13_","worker_4_","worker_14_","worker_10_","worker_0_","worker_6_","worker_11_","worker_5_","worker_2_","worker_8_","worker_7_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_15_")) {
							setState(5);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(16);
							String[] receiverOptionsArray = new String[]{ "worker_2_","worker_11_","worker_9_","worker_0_","worker_7_","worker_14_","worker_5_","worker_6_","worker_12_","worker_10_","worker_15_","worker_1_","worker_4_","worker_8_","worker_13_","worker_3_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_2_")) {
							setState(18);
				...
				case 16:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(16);
							String[] receiverOptionsArray = new String[]{ "worker_11_","worker_12_","worker_1_","worker_3_","worker_7_","worker_6_","worker_0_","worker_4_","worker_10_","worker_14_","worker_15_","worker_5_","worker_9_","worker_8_","worker_13_","worker_2_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_11_")) {
							setState(3);
	...
	public String[] threadNames(){
		return new String[] { "worker_6_","worker_13_","worker_4_","worker_9_","worker_5_","worker_12_","master","worker_2_","worker_14_","worker_0_","worker_1_","worker_8_","worker_10_","worker_15_","worker_3_","worker_11_","worker_7_" };
	}
	
	@Override
	public String getState(){
		return "/" + masterEnvironment.getState() + "/" + worker_0_Environment.getState() + "/" + worker_10_Environment.getState() + "/" + worker_11_Environment.getState() + "/" + worker_12_Environment.getState() + "/" + worker_13_Environment.getState() + "/" + worker_14_Environment.getState() + "/" + worker_15_Environment.getState() + "/" + worker_1_Environment.getState() + "/" + worker_2_Environment.getState() + "/" + worker_3_Environment.getState() + "/" + worker_4_Environment.getState() + "/" + worker_5_Environment.getState() + "/" + worker_6_Environment.getState() + "/" + worker_7_Environment.getState() + "/" + worker_8_Environment.getState() + "/" + worker_9_Environment.getState() + "/";
	}
}

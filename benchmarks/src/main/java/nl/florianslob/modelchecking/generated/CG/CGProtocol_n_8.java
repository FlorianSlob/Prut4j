...
public class CGProtocol_n_8 implements IProtocol {
	...
	public String[] threadNames(){
		return new String[] { "worker_1_","worker_6_","worker_3_","master","worker_4_","worker_7_","worker_2_","worker_5_","worker_0_" };
	}

...
public class ISProtocol_n_6 implements IProtocol {
			...
			switch (state){
				...
				case 19:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_3_")) {
							setState(20);
							worker_3_Queue.put(new ProtocolMessage(box.get(),37));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 21:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_4_")) {
							setState(22);
							worker_4_Queue.put(new ProtocolMessage(box.get(),41));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 23:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_5_")) {
							setState(24);
							worker_5_Queue.put(new ProtocolMessage(box.get(),45));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
	...
	public String[] threadNames(){
		return new String[] { "worker_1_","worker_0_","worker_5_","worker_3_","master","worker_2_","worker_4_" };
	}

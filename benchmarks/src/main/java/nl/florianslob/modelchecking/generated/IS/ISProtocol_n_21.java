...
public class ISProtocol_n_21 implements IProtocol {
			...
			switch (state){
				...
				case 45:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_1_")) {
							setState(46);
							worker_1_Queue.put(new ProtocolMessage(box.get(),89));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 47:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_2_")) {
							setState(48);
							worker_2_Queue.put(new ProtocolMessage(box.get(),93));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 49:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_3_")) {
							setState(50);
							worker_3_Queue.put(new ProtocolMessage(box.get(),97));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 51:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_4_")) {
							setState(52);
							worker_4_Queue.put(new ProtocolMessage(box.get(),101));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 53:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_5_")) {
							setState(54);
							worker_5_Queue.put(new ProtocolMessage(box.get(),105));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 55:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_6_")) {
							setState(56);
							worker_6_Queue.put(new ProtocolMessage(box.get(),109));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 57:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_7_")) {
							setState(58);
							worker_7_Queue.put(new ProtocolMessage(box.get(),113));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 59:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_8_")) {
							setState(60);
							worker_8_Queue.put(new ProtocolMessage(box.get(),117));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 61:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_9_")) {
							setState(62);
							worker_9_Queue.put(new ProtocolMessage(box.get(),121));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 63:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_10_")) {
							setState(64);
							worker_10_Queue.put(new ProtocolMessage(box.get(),125));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 65:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_11_")) {
							setState(66);
							worker_11_Queue.put(new ProtocolMessage(box.get(),129));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 67:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_12_")) {
							setState(68);
							worker_12_Queue.put(new ProtocolMessage(box.get(),133));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 69:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_13_")) {
							setState(70);
							worker_13_Queue.put(new ProtocolMessage(box.get(),137));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 71:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_14_")) {
							setState(72);
							worker_14_Queue.put(new ProtocolMessage(box.get(),141));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 73:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_15_")) {
							setState(74);
							worker_15_Queue.put(new ProtocolMessage(box.get(),145));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 75:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_16_")) {
							setState(76);
							worker_16_Queue.put(new ProtocolMessage(box.get(),149));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 77:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_17_")) {
							setState(78);
							worker_17_Queue.put(new ProtocolMessage(box.get(),153));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 79:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_18_")) {
							setState(80);
							worker_18_Queue.put(new ProtocolMessage(box.get(),157));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 81:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_19_")) {
							setState(82);
							worker_19_Queue.put(new ProtocolMessage(box.get(),161));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 83:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_20_")) {
							setState(84);
							worker_20_Queue.put(new ProtocolMessage(box.get(),165));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
	...
	public String[] threadNames(){
		return new String[] { "worker_0_","worker_15_","worker_7_","worker_16_","worker_13_","worker_17_","worker_8_","worker_9_","worker_20_","worker_10_","worker_19_","worker_12_","worker_5_","worker_4_","worker_3_","worker_6_","worker_18_","worker_1_","worker_14_","worker_11_","worker_2_","master" };
	}

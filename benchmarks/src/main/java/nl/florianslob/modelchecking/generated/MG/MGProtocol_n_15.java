...
public class MGProtocol_n_15 implements Pr {
	...
	private final IEnvironment masterEnvironment = new IEnvironment() {
			...
			switch (state){
				...
				case 78:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_1_")) {
							setState(81);
							interp_1_Queue.put(new ProtocolMessage(box.get(),80));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 90:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_2_")) {
							setState(91);
							interp_2_Queue.put(new ProtocolMessage(box.get(),96));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 98:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_3_")) {
							setState(99);
							interp_3_Queue.put(new ProtocolMessage(box.get(),112));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 106:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_4_")) {
							setState(107);
							interp_4_Queue.put(new ProtocolMessage(box.get(),128));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 114:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_5_")) {
							setState(115);
							interp_5_Queue.put(new ProtocolMessage(box.get(),144));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 122:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_6_")) {
							setState(123);
							interp_6_Queue.put(new ProtocolMessage(box.get(),160));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 130:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_7_")) {
							setState(131);
							interp_7_Queue.put(new ProtocolMessage(box.get(),176));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 138:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_8_")) {
							setState(139);
							interp_8_Queue.put(new ProtocolMessage(box.get(),192));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 146:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_9_")) {
							setState(147);
							interp_9_Queue.put(new ProtocolMessage(box.get(),208));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 154:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_10_")) {
							setState(155);
							interp_10_Queue.put(new ProtocolMessage(box.get(),224));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 162:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_11_")) {
							setState(163);
							interp_11_Queue.put(new ProtocolMessage(box.get(),240));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 170:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_12_")) {
							setState(171);
							interp_12_Queue.put(new ProtocolMessage(box.get(),256));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 178:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_13_")) {
							setState(179);
							interp_13_Queue.put(new ProtocolMessage(box.get(),272));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 186:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_14_")) {
							setState(187);
							interp_14_Queue.put(new ProtocolMessage(box.get(),288));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
		...
		public <Any, AnyInput> Optional<Any> exchange_200_298(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			switch (state){
				case 200:
					if (isCloseAction) {
						setState(201);
		...
		public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			...
			if (state >=200 && state <= 298){
				Optional result = exchange_200_298(box, receiver, isCloseAction);
				if(result != null)
				  return (Optional<Any>) result;
			}
			 throw new NotAllowedTransitionException();
	...
	public String[] threadNames(){
		return new String[] { "interp_2_","interp_13_","rprj_13_","rprj_4_","interp_3_","psinv_14_","psinv_7_","resid_0_","interp_11_","resid_12_","interp_4_","rprj_11_","resid_6_","master","psinv_11_","psinv_4_","interp_0_","resid_4_","rprj_0_","resid_7_","psinv_8_","resid_1_","interp_12_","resid_3_","psinv_6_","psinv_9_","rprj_12_","psinv_12_","rprj_2_","resid_5_","resid_8_","psinv_5_","interp_10_","resid_11_","psinv_2_","interp_7_","interp_1_","psinv_1_","resid_9_","interp_9_","interp_14_","rprj_6_","resid_13_","rprj_3_","rprj_5_","interp_5_","psinv_13_","resid_10_","psinv_10_","interp_8_","interp_6_","psinv_3_","resid_14_","rprj_9_","rprj_14_","resid_2_","rprj_7_","psinv_0_","rprj_1_","rprj_10_","rprj_8_" };
	}
	
	@Override
	public String getState(){
		return "/" + interp_0_Environment.getState() + "/" + interp_10_Environment.getState() + "/" + interp_11_Environment.getState() + "/" + interp_12_Environment.getState() + "/" + interp_13_Environment.getState() + "/" + interp_14_Environment.getState() + "/" + interp_1_Environment.getState() + "/" + interp_2_Environment.getState() + "/" + interp_3_Environment.getState() + "/" + interp_4_Environment.getState() + "/" + interp_5_Environment.getState() + "/" + interp_6_Environment.getState() + "/" + interp_7_Environment.getState() + "/" + interp_8_Environment.getState() + "/" + interp_9_Environment.getState() + "/" + masterEnvironment.getState() + "/" + psinv_0_Environment.getState() + "/" + psinv_10_Environment.getState() + "/" + psinv_11_Environment.getState() + "/" + psinv_12_Environment.getState() + "/" + psinv_13_Environment.getState() + "/" + psinv_14_Environment.getState() + "/" + psinv_1_Environment.getState() + "/" + psinv_2_Environment.getState() + "/" + psinv_3_Environment.getState() + "/" + psinv_4_Environment.getState() + "/" + psinv_5_Environment.getState() + "/" + psinv_6_Environment.getState() + "/" + psinv_7_Environment.getState() + "/" + psinv_8_Environment.getState() + "/" + psinv_9_Environment.getState() + "/" + resid_0_Environment.getState() + "/" + resid_10_Environment.getState() + "/" + resid_11_Environment.getState() + "/" + resid_12_Environment.getState() + "/" + resid_13_Environment.getState() + "/" + resid_14_Environment.getState() + "/" + resid_1_Environment.getState() + "/" + resid_2_Environment.getState() + "/" + resid_3_Environment.getState() + "/" + resid_4_Environment.getState() + "/" + resid_5_Environment.getState() + "/" + resid_6_Environment.getState() + "/" + resid_7_Environment.getState() + "/" + resid_8_Environment.getState() + "/" + resid_9_Environment.getState() + "/" + rprj_0_Environment.getState() + "/" + rprj_10_Environment.getState() + "/" + rprj_11_Environment.getState() + "/" + rprj_12_Environment.getState() + "/" + rprj_13_Environment.getState() + "/" + rprj_14_Environment.getState() + "/" + rprj_1_Environment.getState() + "/" + rprj_2_Environment.getState() + "/" + rprj_3_Environment.getState() + "/" + rprj_4_Environment.getState() + "/" + rprj_5_Environment.getState() + "/" + rprj_6_Environment.getState() + "/" + rprj_7_Environment.getState() + "/" + rprj_8_Environment.getState() + "/" + rprj_9_Environment.getState() + "/";
	}

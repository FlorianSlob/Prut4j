...
public class FTProtocol_n_6 implements Pr {
	...
	public String[] threadNames(){
		return new String[] { "fft_1_","evolve_5_","fft_0_","evolve_3_","fft_3_","fft_4_","master","evolve_4_","fft_5_","evolve_2_","evolve_0_","fft_2_","evolve_1_" };
	}

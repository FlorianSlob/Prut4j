...
public class CGProtocol_strict_n_5 implements IProtocol {
			...
			switch (state){
				...
				case 2:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_1_","worker_4_","worker_2_","worker_0_","worker_3_" };
						...
						if (receiver.equals("worker_2_")) {
							setState(4);
							worker_2_Queue.put(new ProtocolMessage(box.get(),14));
							return Optional.empty();
						}
						if (receiver.equals("worker_0_")) {
							setState(1);
							worker_0_Queue.put(new ProtocolMessage(box.get(),12));
							return Optional.empty();
						}
						if (receiver.equals("worker_3_")) {
							setState(6);
							worker_3_Queue.put(new ProtocolMessage(box.get(),15));
							return Optional.empty();
						}
					}
					if (isCloseAction) {
				...
				case 5:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(5);
							String[] receiverOptionsArray = new String[]{ "worker_4_","worker_1_","worker_2_","worker_0_","worker_3_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_4_")) {
							setState(8);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(5);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_4_","worker_1_","worker_3_","worker_2_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(9);
						...
						if (receiver.equals("worker_4_")) {
							setState(9);
							worker_4_Queue.put(new ProtocolMessage(box.get(),7));
							return Optional.empty();
						}
						if (receiver.equals("worker_1_")) {
							setState(9);
				...
				case 7:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(5);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_2_","worker_4_","worker_3_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(9);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(5);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_3_","worker_2_","worker_1_","worker_4_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(1);
				...
				case 9:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(5);
							String[] receiverOptionsArray = new String[]{ "worker_1_","worker_4_","worker_2_","worker_3_","worker_0_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_1_")) {
							setState(3);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(5);
							String[] receiverOptionsArray = new String[]{ "worker_1_","worker_0_","worker_2_","worker_4_","worker_3_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_1_")) {
							setState(9);
	...
	public String[] threadNames(){
		return new String[] { "worker_4_","worker_1_","worker_2_","master","worker_0_","worker_3_" };
	}

...
public class MGProtocol_n_10 implements Pr {
			...
			switch (state){
				...
				case 29:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_1_")) {
							setState(30);
							interp_1_Queue.put(new ProtocolMessage(box.get(),60));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 37:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_2_")) {
							setState(38);
							interp_2_Queue.put(new ProtocolMessage(box.get(),76));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 45:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_3_")) {
							setState(46);
							interp_3_Queue.put(new ProtocolMessage(box.get(),92));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 53:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_4_")) {
							setState(54);
							interp_4_Queue.put(new ProtocolMessage(box.get(),108));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 61:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_5_")) {
							setState(62);
							interp_5_Queue.put(new ProtocolMessage(box.get(),124));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 69:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_6_")) {
							setState(70);
							interp_6_Queue.put(new ProtocolMessage(box.get(),140));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 77:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_7_")) {
							setState(78);
							interp_7_Queue.put(new ProtocolMessage(box.get(),156));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 85:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_8_")) {
							setState(86);
							interp_8_Queue.put(new ProtocolMessage(box.get(),172));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 93:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interp_9_")) {
							setState(94);
							interp_9_Queue.put(new ProtocolMessage(box.get(),188));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
	...
	public String[] threadNames(){
		return new String[] { "psinv_0_","psinv_8_","rprj_3_","rprj_4_","interp_9_","resid_4_","interp_2_","master","interp_6_","psinv_2_","resid_1_","interp_0_","resid_9_","psinv_9_","rprj_5_","psinv_5_","rprj_0_","resid_3_","psinv_1_","resid_7_","interp_8_","psinv_3_","rprj_9_","psinv_4_","resid_0_","rprj_7_","interp_5_","psinv_7_","resid_8_","interp_7_","resid_5_","rprj_6_","rprj_2_","psinv_6_","interp_3_","rprj_8_","interp_4_","resid_6_","rprj_1_","resid_2_","interp_1_" };
	}

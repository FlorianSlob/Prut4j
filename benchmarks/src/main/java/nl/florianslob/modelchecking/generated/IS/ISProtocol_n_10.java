...
public class ISProtocol_n_10 implements Pr {
	...
	public String[] threadNames(){
		return new String[] { "worker_7_","worker_4_","worker_8_","worker_0_","worker_1_","master","worker_3_","worker_5_","worker_2_","worker_9_","worker_6_" };
	}

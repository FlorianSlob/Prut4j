...
public class CGProtocol_strict_n_24 implements IProtocol {
			...
			switch (state){
				...
				case 2:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_23_","worker_0_","worker_21_","worker_8_","worker_22_","worker_3_","worker_14_","worker_9_","worker_12_","worker_5_","worker_10_","worker_13_","worker_7_","worker_18_","worker_17_","worker_19_","worker_6_","worker_11_","worker_4_","worker_15_","worker_2_","worker_1_","worker_20_","worker_16_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_23_")) {
							setState(15);
							worker_23_Queue.put(new ProtocolMessage(box.get(),60));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_21_")) {
							setState(9);
							worker_21_Queue.put(new ProtocolMessage(box.get(),52));
							return Optional.empty();
						}
						if (receiver.equals("worker_8_")) {
							setState(18);
							worker_8_Queue.put(new ProtocolMessage(box.get(),65));
							return Optional.empty();
						}
						if (receiver.equals("worker_22_")) {
							setState(12);
							worker_22_Queue.put(new ProtocolMessage(box.get(),56));
							return Optional.empty();
						}
						if (receiver.equals("worker_3_")) {
							setState(5);
							worker_3_Queue.put(new ProtocolMessage(box.get(),44));
							return Optional.empty();
						}
						if (receiver.equals("worker_14_")) {
							setState(19);
							worker_14_Queue.put(new ProtocolMessage(box.get(),67));
							return Optional.empty();
						}
						if (receiver.equals("worker_9_")) {
							setState(21);
							worker_9_Queue.put(new ProtocolMessage(box.get(),68));
							return Optional.empty();
						}
						if (receiver.equals("worker_12_")) {
							setState(14);
							worker_12_Queue.put(new ProtocolMessage(box.get(),59));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_10_")) {
							setState(8);
							worker_10_Queue.put(new ProtocolMessage(box.get(),51));
							return Optional.empty();
						}
						if (receiver.equals("worker_13_")) {
							setState(17);
							worker_13_Queue.put(new ProtocolMessage(box.get(),64));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_18_")) {
							setState(25);
							worker_18_Queue.put(new ProtocolMessage(box.get(),72));
							return Optional.empty();
						}
						if (receiver.equals("worker_17_")) {
							setState(24);
							worker_17_Queue.put(new ProtocolMessage(box.get(),71));
							return Optional.empty();
						}
						if (receiver.equals("worker_19_")) {
							setState(26);
							worker_19_Queue.put(new ProtocolMessage(box.get(),73));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_11_")) {
							setState(11);
							worker_11_Queue.put(new ProtocolMessage(box.get(),55));
							return Optional.empty();
						}
						if (receiver.equals("worker_4_")) {
							setState(7);
							worker_4_Queue.put(new ProtocolMessage(box.get(),47));
							return Optional.empty();
						}
						if (receiver.equals("worker_15_")) {
							setState(22);
							worker_15_Queue.put(new ProtocolMessage(box.get(),69));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_20_")) {
							setState(6);
							worker_20_Queue.put(new ProtocolMessage(box.get(),46));
							return Optional.empty();
						}
						if (receiver.equals("worker_16_")) {
							setState(23);
							worker_16_Queue.put(new ProtocolMessage(box.get(),70));
							return Optional.empty();
						}
					}
					if (isCloseAction) {
				...
				case 20:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(24);
							String[] receiverOptionsArray = new String[]{ "worker_23_","worker_14_","worker_10_","worker_5_","worker_1_","worker_16_","worker_3_","worker_7_","worker_15_","worker_20_","worker_19_","worker_18_","worker_11_","worker_13_","worker_12_","worker_2_","worker_9_","worker_6_","worker_21_","worker_22_","worker_4_","worker_17_","worker_8_","worker_0_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_23_")) {
							setState(28);
							worker_23_Queue.put(new ProtocolMessage(box.get(),21));
							return Optional.empty();
						}
						if (receiver.equals("worker_14_")) {
							setState(28);
							worker_14_Queue.put(new ProtocolMessage(box.get(),26));
							return Optional.empty();
						}
						if (receiver.equals("worker_10_")) {
							setState(28);
						...
						if (receiver.equals("worker_5_")) {
							setState(28);
							worker_5_Queue.put(new ProtocolMessage(box.get(),22));
							return Optional.empty();
						}
						if (receiver.equals("worker_1_")) {
							setState(28);
						...
						if (receiver.equals("worker_16_")) {
							setState(28);
							worker_16_Queue.put(new ProtocolMessage(box.get(),31));
							return Optional.empty();
						}
						if (receiver.equals("worker_3_")) {
							setState(28);
						...
						if (receiver.equals("worker_7_")) {
							setState(28);
							worker_7_Queue.put(new ProtocolMessage(box.get(),27));
							return Optional.empty();
						}
						if (receiver.equals("worker_15_")) {
							setState(28);
							worker_15_Queue.put(new ProtocolMessage(box.get(),29));
							return Optional.empty();
						}
						if (receiver.equals("worker_20_")) {
							setState(28);
						...
						if (receiver.equals("worker_19_")) {
							setState(28);
							worker_19_Queue.put(new ProtocolMessage(box.get(),35));
							return Optional.empty();
						}
						if (receiver.equals("worker_18_")) {
							setState(28);
							worker_18_Queue.put(new ProtocolMessage(box.get(),34));
							return Optional.empty();
						}
						if (receiver.equals("worker_11_")) {
							setState(28);
						...
						if (receiver.equals("worker_13_")) {
							setState(28);
							worker_13_Queue.put(new ProtocolMessage(box.get(),24));
							return Optional.empty();
						}
						if (receiver.equals("worker_12_")) {
							setState(28);
						...
						if (receiver.equals("worker_9_")) {
							setState(28);
							worker_9_Queue.put(new ProtocolMessage(box.get(),32));
							return Optional.empty();
						}
						if (receiver.equals("worker_6_")) {
							setState(28);
							worker_6_Queue.put(new ProtocolMessage(box.get(),25));
							return Optional.empty();
						}
						if (receiver.equals("worker_21_")) {
							setState(28);
						...
						if (receiver.equals("worker_17_")) {
							setState(28);
							worker_17_Queue.put(new ProtocolMessage(box.get(),33));
							return Optional.empty();
						}
						if (receiver.equals("worker_8_")) {
							setState(28);
							worker_8_Queue.put(new ProtocolMessage(box.get(),30));
							return Optional.empty();
						}
						if (receiver.equals("worker_0_")) {
							setState(28);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(24);
							String[] receiverOptionsArray = new String[]{ "worker_19_","worker_0_","worker_16_","worker_11_","worker_21_","worker_18_","worker_22_","worker_1_","worker_20_","worker_23_","worker_8_","worker_17_","worker_10_","worker_5_","worker_7_","worker_4_","worker_2_","worker_12_","worker_13_","worker_3_","worker_15_","worker_6_","worker_14_","worker_9_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_19_")) {
							setState(26);
					...
					if(!box.isPresent() && !isCloseAction){
						...
						if (objectToGet.OriginalTargetStateId == 74) {
							setState(27);
				...
				case 27:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(24);
							String[] receiverOptionsArray = new String[]{ "worker_6_","worker_18_","worker_16_","worker_4_","worker_3_","worker_0_","worker_11_","worker_14_","worker_22_","worker_8_","worker_5_","worker_23_","worker_9_","worker_15_","worker_10_","worker_19_","worker_12_","worker_7_","worker_20_","worker_2_","worker_1_","worker_13_","worker_17_","worker_21_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_6_")) {
							setState(28);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(24);
							String[] receiverOptionsArray = new String[]{ "worker_16_","worker_10_","worker_14_","worker_0_","worker_7_","worker_6_","worker_19_","worker_23_","worker_11_","worker_22_","worker_21_","worker_3_","worker_15_","worker_2_","worker_1_","worker_4_","worker_18_","worker_5_","worker_20_","worker_12_","worker_13_","worker_8_","worker_9_","worker_17_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_16_")) {
							setState(23);
				...
				case 28:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(24);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_23_","worker_9_","worker_18_","worker_14_","worker_13_","worker_1_","worker_12_","worker_22_","worker_16_","worker_2_","worker_19_","worker_5_","worker_11_","worker_20_","worker_17_","worker_10_","worker_21_","worker_7_","worker_15_","worker_8_","worker_4_","worker_3_","worker_6_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(1);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(24);
							String[] receiverOptionsArray = new String[]{ "worker_20_","worker_12_","worker_1_","worker_17_","worker_22_","worker_8_","worker_16_","worker_3_","worker_6_","worker_19_","worker_9_","worker_18_","worker_14_","worker_2_","worker_23_","worker_15_","worker_0_","worker_7_","worker_13_","worker_5_","worker_21_","worker_11_","worker_4_","worker_10_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_20_")) {
							setState(28);
	...
	private final IEnvironment worker_23_Environment = new IEnvironment() {
		private int state = 3;
			...
			switch (state){
				case 0:
					...
					if(!box.isPresent() && !isCloseAction){
						...
						// Disabling unchecked inspection: We did check the class in the if statement above
						//noinspection unchecked
						return Optional.of((Any)worker_23_Queue.take().Message);
					}
					throw new NotAllowedTransitionException();
				case 1:
					if (isCloseAction) {
	...
	public IEnvironment getEnvironment(String environmentName) throws Exception{
		switch (environmentName){
			...
			case "worker_23_": return worker_23_Environment;

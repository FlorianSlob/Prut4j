...
public class CGProtocol_strict_n_18 implements IProtocol {
			...
			switch (state){
				...
				case 5:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_2_","worker_8_","worker_3_","worker_0_","worker_14_","worker_9_","worker_6_","worker_13_","worker_17_","worker_12_","worker_11_","worker_10_","worker_4_","worker_16_","worker_7_","worker_15_","worker_1_","worker_5_" };
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(18);
							String[] receiverOptionsArray = new String[]{ "worker_6_","worker_4_","worker_16_","worker_17_","worker_8_","worker_0_","worker_12_","worker_14_","worker_2_","worker_9_","worker_3_","worker_11_","worker_7_","worker_10_","worker_1_","worker_5_","worker_13_","worker_15_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_6_")) {
							setState(9);
							worker_6_Queue.put(new ProtocolMessage(box.get(),45));
							return Optional.empty();
						}
						if (receiver.equals("worker_4_")) {
							setState(3);
							worker_4_Queue.put(new ProtocolMessage(box.get(),38));
							return Optional.empty();
						}
						if (receiver.equals("worker_16_")) {
							setState(19);
							worker_16_Queue.put(new ProtocolMessage(box.get(),54));
							return Optional.empty();
						}
						if (receiver.equals("worker_17_")) {
							setState(21);
							worker_17_Queue.put(new ProtocolMessage(box.get(),55));
							return Optional.empty();
						}
						if (receiver.equals("worker_8_")) {
							setState(14);
							worker_8_Queue.put(new ProtocolMessage(box.get(),50));
							return Optional.empty();
						}
						if (receiver.equals("worker_0_")) {
							setState(18);
						...
						if (receiver.equals("worker_12_")) {
							setState(11);
							worker_12_Queue.put(new ProtocolMessage(box.get(),46));
							return Optional.empty();
						}
						if (receiver.equals("worker_14_")) {
							setState(15);
							worker_14_Queue.put(new ProtocolMessage(box.get(),51));
							return Optional.empty();
						}
						if (receiver.equals("worker_2_")) {
							setState(0);
						...
						if (receiver.equals("worker_9_")) {
							setState(16);
							worker_9_Queue.put(new ProtocolMessage(box.get(),52));
							return Optional.empty();
						}
						if (receiver.equals("worker_3_")) {
							setState(1);
							worker_3_Queue.put(new ProtocolMessage(box.get(),36));
							return Optional.empty();
						}
						if (receiver.equals("worker_11_")) {
							setState(8);
							worker_11_Queue.put(new ProtocolMessage(box.get(),44));
							return Optional.empty();
						}
						if (receiver.equals("worker_7_")) {
							setState(12);
							worker_7_Queue.put(new ProtocolMessage(box.get(),47));
							return Optional.empty();
						}
						if (receiver.equals("worker_10_")) {
							setState(4);
							worker_10_Queue.put(new ProtocolMessage(box.get(),41));
							return Optional.empty();
						}
						if (receiver.equals("worker_1_")) {
							setState(22);
							worker_1_Queue.put(new ProtocolMessage(box.get(),33));
							return Optional.empty();
						}
						if (receiver.equals("worker_5_")) {
							setState(6);
							worker_5_Queue.put(new ProtocolMessage(box.get(),42));
							return Optional.empty();
						}
						if (receiver.equals("worker_13_")) {
							setState(13);
							worker_13_Queue.put(new ProtocolMessage(box.get(),49));
							return Optional.empty();
						}
						if (receiver.equals("worker_15_")) {
							setState(17);
							worker_15_Queue.put(new ProtocolMessage(box.get(),53));
							return Optional.empty();
						}
					}
					if (isCloseAction) {
				...
				case 7:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(18);
							String[] receiverOptionsArray = new String[]{ "worker_5_","worker_9_","worker_13_","worker_14_","worker_16_","worker_6_","worker_8_","worker_11_","worker_17_","worker_4_","worker_1_","worker_15_","worker_3_","worker_12_","worker_0_","worker_2_","worker_10_","worker_7_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_5_")) {
							setState(7);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(18);
							String[] receiverOptionsArray = new String[]{ "worker_17_","worker_3_","worker_14_","worker_5_","worker_2_","worker_8_","worker_0_","worker_13_","worker_16_","worker_10_","worker_4_","worker_6_","worker_9_","worker_12_","worker_7_","worker_1_","worker_11_","worker_15_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_17_")) {
							setState(21);
				...
				case 10:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(18);
							String[] receiverOptionsArray = new String[]{ "worker_5_","worker_15_","worker_12_","worker_11_","worker_14_","worker_4_","worker_2_","worker_6_","worker_17_","worker_16_","worker_1_","worker_9_","worker_13_","worker_0_","worker_3_","worker_8_","worker_10_","worker_7_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_5_")) {
							setState(6);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(18);
							String[] receiverOptionsArray = new String[]{ "worker_16_","worker_2_","worker_7_","worker_9_","worker_11_","worker_5_","worker_8_","worker_14_","worker_10_","worker_4_","worker_0_","worker_13_","worker_3_","worker_6_","worker_1_","worker_15_","worker_17_","worker_12_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_16_")) {
							setState(7);
				...
				case 20:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(18);
							String[] receiverOptionsArray = new String[]{ "worker_8_","worker_13_","worker_11_","worker_15_","worker_12_","worker_5_","worker_17_","worker_0_","worker_10_","worker_9_","worker_7_","worker_6_","worker_1_","worker_14_","worker_16_","worker_3_","worker_4_","worker_2_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_8_")) {
							setState(14);
	...
	public String[] threadNames(){
		return new String[] { "worker_0_","master","worker_9_","worker_5_","worker_3_","worker_1_","worker_4_","worker_2_","worker_14_","worker_17_","worker_15_","worker_13_","worker_6_","worker_16_","worker_8_","worker_10_","worker_11_","worker_12_","worker_7_" };
	}
	
	@Override
	public String getState(){
		return "/" + masterEnvironment.getState() + "/" + worker_0_Environment.getState() + "/" + worker_10_Environment.getState() + "/" + worker_11_Environment.getState() + "/" + worker_12_Environment.getState() + "/" + worker_13_Environment.getState() + "/" + worker_14_Environment.getState() + "/" + worker_15_Environment.getState() + "/" + worker_16_Environment.getState() + "/" + worker_17_Environment.getState() + "/" + worker_1_Environment.getState() + "/" + worker_2_Environment.getState() + "/" + worker_3_Environment.getState() + "/" + worker_4_Environment.getState() + "/" + worker_5_Environment.getState() + "/" + worker_6_Environment.getState() + "/" + worker_7_Environment.getState() + "/" + worker_8_Environment.getState() + "/" + worker_9_Environment.getState() + "/";
	}
}

...
public class ISProtocol_n_9 implements Pr {
	...
	public String[] threadNames(){
		return new String[] { "worker_3_","worker_6_","worker_7_","worker_8_","worker_1_","worker_0_","master","worker_4_","worker_5_","worker_2_" };
	}

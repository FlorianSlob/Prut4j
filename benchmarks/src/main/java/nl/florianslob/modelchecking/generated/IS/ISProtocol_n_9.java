...
public class ISProtocol_n_9 implements IProtocol {
	...
	public String[] threadNames(){
		return new String[] { "worker_1_","master","worker_8_","worker_7_","worker_2_","worker_3_","worker_4_","worker_0_","worker_5_","worker_6_" };
	}

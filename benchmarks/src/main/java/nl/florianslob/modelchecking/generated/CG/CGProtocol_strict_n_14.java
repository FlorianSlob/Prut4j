...
public class CGProtocol_strict_n_14 implements IProtocol {
	...
	private final IEnvironment masterEnvironment = new IEnvironment() {
		...
		public <Any, AnyInput> Optional<Any> exchange_0_19(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			switch (state){
				case 0:
				...
				case 6:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_3_","worker_12_","worker_8_","worker_13_","worker_4_","worker_5_","worker_1_","worker_11_","worker_2_","worker_0_","worker_7_","worker_6_","worker_9_","worker_10_" };
						...
						if (receiver.equals("worker_8_")) {
							setState(7);
							worker_8_Queue.put(new ProtocolMessage(box.get(),24));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_7_")) {
							setState(7);
							worker_7_Queue.put(new ProtocolMessage(box.get(),22));
							return Optional.empty();
						}
						...
						if (receiver.equals("worker_9_")) {
							setState(7);
							worker_9_Queue.put(new ProtocolMessage(box.get(),25));
							return Optional.empty();
						}
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(14);
							String[] receiverOptionsArray = new String[]{ "worker_5_","worker_11_","worker_8_","worker_2_","worker_13_","worker_3_","worker_0_","worker_6_","worker_9_","worker_10_","worker_7_","worker_4_","worker_12_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_5_")) {
							setState(17);
							worker_5_Queue.put(new ProtocolMessage(box.get(),34));
							return Optional.empty();
						}
						if (receiver.equals("worker_11_")) {
							setState(18);
							worker_11_Queue.put(new ProtocolMessage(box.get(),36));
							return Optional.empty();
						}
						if (receiver.equals("worker_8_")) {
							setState(5);
							worker_8_Queue.put(new ProtocolMessage(box.get(),42));
							return Optional.empty();
						}
						if (receiver.equals("worker_2_")) {
							setState(12);
						...
						if (receiver.equals("worker_13_")) {
							setState(4);
							worker_13_Queue.put(new ProtocolMessage(box.get(),41));
							return Optional.empty();
						}
						if (receiver.equals("worker_3_")) {
							setState(13);
							worker_3_Queue.put(new ProtocolMessage(box.get(),29));
							return Optional.empty();
						}
						if (receiver.equals("worker_0_")) {
							setState(9);
						...
						if (receiver.equals("worker_6_")) {
							setState(0);
							worker_6_Queue.put(new ProtocolMessage(box.get(),37));
							return Optional.empty();
						}
						if (receiver.equals("worker_9_")) {
							setState(8);
							worker_9_Queue.put(new ProtocolMessage(box.get(),43));
							return Optional.empty();
						}
						if (receiver.equals("worker_10_")) {
							setState(15);
							worker_10_Queue.put(new ProtocolMessage(box.get(),33));
							return Optional.empty();
						}
						if (receiver.equals("worker_7_")) {
							setState(3);
							worker_7_Queue.put(new ProtocolMessage(box.get(),39));
							return Optional.empty();
						}
						if (receiver.equals("worker_4_")) {
							setState(14);
							worker_4_Queue.put(new ProtocolMessage(box.get(),30));
							return Optional.empty();
						}
						if (receiver.equals("worker_12_")) {
							setState(1);
							worker_12_Queue.put(new ProtocolMessage(box.get(),38));
							return Optional.empty();
						}
						if (receiver.equals("worker_1_")) {
							setState(11);
				...
				case 7:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(14);
							String[] receiverOptionsArray = new String[]{ "worker_8_","worker_6_","worker_9_","worker_5_","worker_2_","worker_11_","worker_13_","worker_3_","worker_4_","worker_1_","worker_0_","worker_10_","worker_7_","worker_12_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_8_")) {
							setState(5);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(14);
							String[] receiverOptionsArray = new String[]{ "worker_7_","worker_12_","worker_5_","worker_11_","worker_0_","worker_4_","worker_3_","worker_9_","worker_8_","worker_2_","worker_6_","worker_1_","worker_13_","worker_10_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_7_")) {
							setState(7);
				...
				case 10:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(14);
							String[] receiverOptionsArray = new String[]{ "worker_10_","worker_1_","worker_9_","worker_2_","worker_5_","worker_3_","worker_4_","worker_8_","worker_7_","worker_13_","worker_0_","worker_6_","worker_11_","worker_12_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_10_")) {
							setState(15);
				...
				case 16:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(14);
							String[] receiverOptionsArray = new String[]{ "worker_13_","worker_11_","worker_1_","worker_10_","worker_9_","worker_12_","worker_0_","worker_5_","worker_7_","worker_4_","worker_8_","worker_2_","worker_6_","worker_3_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_13_")) {
							setState(4);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(14);
							String[] receiverOptionsArray = new String[]{ "worker_7_","worker_11_","worker_12_","worker_1_","worker_4_","worker_13_","worker_2_","worker_10_","worker_8_","worker_3_","worker_6_","worker_9_","worker_5_","worker_0_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_7_")) {
							setState(7);
		...
		public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			if (state >=0 && state <= 19){
				Optional result = exchange_0_19(box, receiver, isCloseAction);
				if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "worker_13_","worker_7_","worker_3_","worker_12_","worker_5_","master","worker_1_","worker_2_","worker_8_","worker_9_","worker_11_","worker_0_","worker_10_","worker_4_","worker_6_" };
	}
	
	@Override
	public String getState(){
		return "/" + masterEnvironment.getState() + "/" + worker_0_Environment.getState() + "/" + worker_10_Environment.getState() + "/" + worker_11_Environment.getState() + "/" + worker_12_Environment.getState() + "/" + worker_13_Environment.getState() + "/" + worker_1_Environment.getState() + "/" + worker_2_Environment.getState() + "/" + worker_3_Environment.getState() + "/" + worker_4_Environment.getState() + "/" + worker_5_Environment.getState() + "/" + worker_6_Environment.getState() + "/" + worker_7_Environment.getState() + "/" + worker_8_Environment.getState() + "/" + worker_9_Environment.getState() + "/";
	}
}

...
public class MGProtocol_n_22 implements IProtocol {
			...
			switch (state){
				...
				case 47:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_0_")) {
							setState(48);
							psinv_0_Queue.put(new ProtocolMessage(box.get(),96));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 49:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_0_")) {
							setState(50);
							rprj_0_Queue.put(new ProtocolMessage(box.get(),100));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 51:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_0_")) {
							setState(52);
							resid_0_Queue.put(new ProtocolMessage(box.get(),104));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 53:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_1_")) {
							setState(54);
							interpd_1_Queue.put(new ProtocolMessage(box.get(),108));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 55:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_1_")) {
							setState(56);
							psinv_1_Queue.put(new ProtocolMessage(box.get(),112));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 57:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_1_")) {
							setState(58);
							rprj_1_Queue.put(new ProtocolMessage(box.get(),116));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 59:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_1_")) {
							setState(60);
							resid_1_Queue.put(new ProtocolMessage(box.get(),120));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 61:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_2_")) {
							setState(62);
							interpd_2_Queue.put(new ProtocolMessage(box.get(),124));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 63:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_2_")) {
							setState(64);
							psinv_2_Queue.put(new ProtocolMessage(box.get(),128));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 65:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_2_")) {
							setState(66);
							rprj_2_Queue.put(new ProtocolMessage(box.get(),132));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 67:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_2_")) {
							setState(68);
							resid_2_Queue.put(new ProtocolMessage(box.get(),136));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 69:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_3_")) {
							setState(70);
							interpd_3_Queue.put(new ProtocolMessage(box.get(),140));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 71:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_3_")) {
							setState(72);
							psinv_3_Queue.put(new ProtocolMessage(box.get(),144));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 73:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_3_")) {
							setState(74);
							rprj_3_Queue.put(new ProtocolMessage(box.get(),148));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 75:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_3_")) {
							setState(76);
							resid_3_Queue.put(new ProtocolMessage(box.get(),152));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 77:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_4_")) {
							setState(78);
							interpd_4_Queue.put(new ProtocolMessage(box.get(),156));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 79:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_4_")) {
							setState(80);
							psinv_4_Queue.put(new ProtocolMessage(box.get(),160));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 81:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_4_")) {
							setState(82);
							rprj_4_Queue.put(new ProtocolMessage(box.get(),164));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 83:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_4_")) {
							setState(84);
							resid_4_Queue.put(new ProtocolMessage(box.get(),168));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 85:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_5_")) {
							setState(86);
							interpd_5_Queue.put(new ProtocolMessage(box.get(),172));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 87:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_5_")) {
							setState(88);
							psinv_5_Queue.put(new ProtocolMessage(box.get(),176));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 89:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_5_")) {
							setState(90);
							rprj_5_Queue.put(new ProtocolMessage(box.get(),180));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 91:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_5_")) {
							setState(92);
							resid_5_Queue.put(new ProtocolMessage(box.get(),184));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 93:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_6_")) {
							setState(94);
							interpd_6_Queue.put(new ProtocolMessage(box.get(),188));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 95:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_6_")) {
							setState(96);
							psinv_6_Queue.put(new ProtocolMessage(box.get(),192));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 97:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_6_")) {
							setState(98);
							rprj_6_Queue.put(new ProtocolMessage(box.get(),196));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 99:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_6_")) {
							setState(100);
							resid_6_Queue.put(new ProtocolMessage(box.get(),200));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 101:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_7_")) {
							setState(102);
							interpd_7_Queue.put(new ProtocolMessage(box.get(),204));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 103:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_7_")) {
							setState(104);
							psinv_7_Queue.put(new ProtocolMessage(box.get(),208));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 105:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_7_")) {
							setState(106);
							rprj_7_Queue.put(new ProtocolMessage(box.get(),212));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 107:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_7_")) {
							setState(108);
							resid_7_Queue.put(new ProtocolMessage(box.get(),216));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 109:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_8_")) {
							setState(110);
							interpd_8_Queue.put(new ProtocolMessage(box.get(),220));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 111:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_8_")) {
							setState(112);
							psinv_8_Queue.put(new ProtocolMessage(box.get(),224));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 113:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_8_")) {
							setState(114);
							rprj_8_Queue.put(new ProtocolMessage(box.get(),228));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 115:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_8_")) {
							setState(116);
							resid_8_Queue.put(new ProtocolMessage(box.get(),232));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 117:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_9_")) {
							setState(118);
							interpd_9_Queue.put(new ProtocolMessage(box.get(),236));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 119:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_9_")) {
							setState(120);
							psinv_9_Queue.put(new ProtocolMessage(box.get(),240));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 121:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_9_")) {
							setState(122);
							rprj_9_Queue.put(new ProtocolMessage(box.get(),244));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 123:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_9_")) {
							setState(124);
							resid_9_Queue.put(new ProtocolMessage(box.get(),248));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 125:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_10_")) {
							setState(126);
							interpd_10_Queue.put(new ProtocolMessage(box.get(),252));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 127:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_10_")) {
							setState(128);
							psinv_10_Queue.put(new ProtocolMessage(box.get(),256));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 129:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_10_")) {
							setState(130);
							rprj_10_Queue.put(new ProtocolMessage(box.get(),260));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 131:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_10_")) {
							setState(132);
							resid_10_Queue.put(new ProtocolMessage(box.get(),264));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 133:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_11_")) {
							setState(134);
							interpd_11_Queue.put(new ProtocolMessage(box.get(),268));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 135:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_11_")) {
							setState(136);
							psinv_11_Queue.put(new ProtocolMessage(box.get(),272));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 137:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_11_")) {
							setState(138);
							rprj_11_Queue.put(new ProtocolMessage(box.get(),276));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 139:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_11_")) {
							setState(140);
							resid_11_Queue.put(new ProtocolMessage(box.get(),280));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 141:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_12_")) {
							setState(142);
							interpd_12_Queue.put(new ProtocolMessage(box.get(),284));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 143:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_12_")) {
							setState(144);
							psinv_12_Queue.put(new ProtocolMessage(box.get(),288));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 145:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_12_")) {
							setState(146);
							rprj_12_Queue.put(new ProtocolMessage(box.get(),292));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 147:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_12_")) {
							setState(148);
							resid_12_Queue.put(new ProtocolMessage(box.get(),296));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 149:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_13_")) {
							setState(150);
							interpd_13_Queue.put(new ProtocolMessage(box.get(),300));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 151:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_13_")) {
							setState(152);
							psinv_13_Queue.put(new ProtocolMessage(box.get(),304));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 153:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_13_")) {
							setState(154);
							rprj_13_Queue.put(new ProtocolMessage(box.get(),308));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 155:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_13_")) {
							setState(156);
							resid_13_Queue.put(new ProtocolMessage(box.get(),312));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 157:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_14_")) {
							setState(158);
							interpd_14_Queue.put(new ProtocolMessage(box.get(),316));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 159:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_14_")) {
							setState(160);
							psinv_14_Queue.put(new ProtocolMessage(box.get(),320));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 161:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_14_")) {
							setState(162);
							rprj_14_Queue.put(new ProtocolMessage(box.get(),324));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 163:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_14_")) {
							setState(164);
							resid_14_Queue.put(new ProtocolMessage(box.get(),328));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 165:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_15_")) {
							setState(166);
							interpd_15_Queue.put(new ProtocolMessage(box.get(),332));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 167:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_15_")) {
							setState(168);
							psinv_15_Queue.put(new ProtocolMessage(box.get(),336));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 169:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_15_")) {
							setState(170);
							rprj_15_Queue.put(new ProtocolMessage(box.get(),340));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 171:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_15_")) {
							setState(172);
							resid_15_Queue.put(new ProtocolMessage(box.get(),344));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 173:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_16_")) {
							setState(174);
							interpd_16_Queue.put(new ProtocolMessage(box.get(),348));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 175:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_16_")) {
							setState(176);
							psinv_16_Queue.put(new ProtocolMessage(box.get(),352));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 177:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_16_")) {
							setState(178);
							rprj_16_Queue.put(new ProtocolMessage(box.get(),356));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 179:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_16_")) {
							setState(180);
							resid_16_Queue.put(new ProtocolMessage(box.get(),360));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 181:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_17_")) {
							setState(182);
							interpd_17_Queue.put(new ProtocolMessage(box.get(),364));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 183:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_17_")) {
							setState(184);
							psinv_17_Queue.put(new ProtocolMessage(box.get(),368));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 185:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_17_")) {
							setState(186);
							rprj_17_Queue.put(new ProtocolMessage(box.get(),372));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 187:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_17_")) {
							setState(188);
							resid_17_Queue.put(new ProtocolMessage(box.get(),376));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 189:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_18_")) {
							setState(190);
							interpd_18_Queue.put(new ProtocolMessage(box.get(),380));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 191:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_18_")) {
							setState(192);
							psinv_18_Queue.put(new ProtocolMessage(box.get(),384));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 193:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_18_")) {
							setState(194);
							rprj_18_Queue.put(new ProtocolMessage(box.get(),388));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 195:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_18_")) {
							setState(196);
							resid_18_Queue.put(new ProtocolMessage(box.get(),392));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 197:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_19_")) {
							setState(198);
							interpd_19_Queue.put(new ProtocolMessage(box.get(),396));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 199:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_19_")) {
							setState(200);
							psinv_19_Queue.put(new ProtocolMessage(box.get(),400));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
			...
			switch (state){
				...
				case 201:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_19_")) {
							setState(202);
							rprj_19_Queue.put(new ProtocolMessage(box.get(),404));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 203:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_19_")) {
							setState(204);
							resid_19_Queue.put(new ProtocolMessage(box.get(),408));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 205:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_20_")) {
							setState(206);
							interpd_20_Queue.put(new ProtocolMessage(box.get(),412));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 207:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_20_")) {
							setState(208);
							psinv_20_Queue.put(new ProtocolMessage(box.get(),416));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 209:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_20_")) {
							setState(210);
							rprj_20_Queue.put(new ProtocolMessage(box.get(),420));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 211:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_20_")) {
							setState(212);
							resid_20_Queue.put(new ProtocolMessage(box.get(),424));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 213:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("interpd_21_")) {
							setState(214);
							interpd_21_Queue.put(new ProtocolMessage(box.get(),428));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 215:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("psinv_21_")) {
							setState(216);
							psinv_21_Queue.put(new ProtocolMessage(box.get(),432));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 217:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("rprj_21_")) {
							setState(218);
							rprj_21_Queue.put(new ProtocolMessage(box.get(),436));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 219:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("resid_21_")) {
							setState(220);
							resid_21_Queue.put(new ProtocolMessage(box.get(),440));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 309:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_1_")) {
							setState(310);
							psinv_1_Queue.put(new ProtocolMessage(box.get(),621));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 310:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_2_")) {
							setState(311);
							psinv_2_Queue.put(new ProtocolMessage(box.get(),623));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 311:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_3_")) {
							setState(312);
							psinv_3_Queue.put(new ProtocolMessage(box.get(),625));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 312:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_4_")) {
							setState(313);
							psinv_4_Queue.put(new ProtocolMessage(box.get(),627));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 313:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_5_")) {
							setState(314);
							psinv_5_Queue.put(new ProtocolMessage(box.get(),629));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 314:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_6_")) {
							setState(315);
							psinv_6_Queue.put(new ProtocolMessage(box.get(),631));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 315:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_7_")) {
							setState(316);
							psinv_7_Queue.put(new ProtocolMessage(box.get(),633));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 316:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_8_")) {
							setState(317);
							psinv_8_Queue.put(new ProtocolMessage(box.get(),635));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 317:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_9_")) {
							setState(318);
							psinv_9_Queue.put(new ProtocolMessage(box.get(),637));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 318:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_10_")) {
							setState(319);
							psinv_10_Queue.put(new ProtocolMessage(box.get(),639));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 319:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_11_")) {
							setState(320);
							psinv_11_Queue.put(new ProtocolMessage(box.get(),641));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 320:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_12_")) {
							setState(321);
							psinv_12_Queue.put(new ProtocolMessage(box.get(),643));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 321:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_13_")) {
							setState(322);
							psinv_13_Queue.put(new ProtocolMessage(box.get(),645));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 322:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_14_")) {
							setState(323);
							psinv_14_Queue.put(new ProtocolMessage(box.get(),647));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 323:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_15_")) {
							setState(324);
							psinv_15_Queue.put(new ProtocolMessage(box.get(),649));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 324:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_16_")) {
							setState(325);
							psinv_16_Queue.put(new ProtocolMessage(box.get(),651));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 325:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_17_")) {
							setState(326);
							psinv_17_Queue.put(new ProtocolMessage(box.get(),653));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 326:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_18_")) {
							setState(327);
							psinv_18_Queue.put(new ProtocolMessage(box.get(),655));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 327:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_19_")) {
							setState(328);
							psinv_19_Queue.put(new ProtocolMessage(box.get(),657));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 328:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_20_")) {
							setState(329);
							psinv_20_Queue.put(new ProtocolMessage(box.get(),659));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 329:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.PsinvMessage.class ) {
						...
						if (receiver.equals("psinv_21_")) {
							setState(330);
							psinv_21_Queue.put(new ProtocolMessage(box.get(),661));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 352:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_1_")) {
							setState(353);
							rprj_1_Queue.put(new ProtocolMessage(box.get(),707));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 353:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_2_")) {
							setState(354);
							rprj_2_Queue.put(new ProtocolMessage(box.get(),709));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 354:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_3_")) {
							setState(355);
							rprj_3_Queue.put(new ProtocolMessage(box.get(),711));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 355:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_4_")) {
							setState(356);
							rprj_4_Queue.put(new ProtocolMessage(box.get(),713));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 356:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_5_")) {
							setState(357);
							rprj_5_Queue.put(new ProtocolMessage(box.get(),715));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 357:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_6_")) {
							setState(358);
							rprj_6_Queue.put(new ProtocolMessage(box.get(),717));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 358:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_7_")) {
							setState(359);
							rprj_7_Queue.put(new ProtocolMessage(box.get(),719));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 359:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_8_")) {
							setState(360);
							rprj_8_Queue.put(new ProtocolMessage(box.get(),721));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 360:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_9_")) {
							setState(361);
							rprj_9_Queue.put(new ProtocolMessage(box.get(),723));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 361:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_10_")) {
							setState(362);
							rprj_10_Queue.put(new ProtocolMessage(box.get(),725));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 362:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_11_")) {
							setState(363);
							rprj_11_Queue.put(new ProtocolMessage(box.get(),727));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 363:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_12_")) {
							setState(364);
							rprj_12_Queue.put(new ProtocolMessage(box.get(),729));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 364:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_13_")) {
							setState(365);
							rprj_13_Queue.put(new ProtocolMessage(box.get(),731));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 365:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_14_")) {
							setState(366);
							rprj_14_Queue.put(new ProtocolMessage(box.get(),733));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 366:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_15_")) {
							setState(367);
							rprj_15_Queue.put(new ProtocolMessage(box.get(),735));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 367:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_16_")) {
							setState(368);
							rprj_16_Queue.put(new ProtocolMessage(box.get(),737));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 368:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_17_")) {
							setState(369);
							rprj_17_Queue.put(new ProtocolMessage(box.get(),739));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 369:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_18_")) {
							setState(370);
							rprj_18_Queue.put(new ProtocolMessage(box.get(),741));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 370:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_19_")) {
							setState(371);
							rprj_19_Queue.put(new ProtocolMessage(box.get(),743));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 371:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_20_")) {
							setState(372);
							rprj_20_Queue.put(new ProtocolMessage(box.get(),745));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 372:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.RprjMessage.class ) {
						...
						if (receiver.equals("rprj_21_")) {
							setState(373);
							rprj_21_Queue.put(new ProtocolMessage(box.get(),747));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 395:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_1_")) {
							setState(396);
							resid_1_Queue.put(new ProtocolMessage(box.get(),793));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 396:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_2_")) {
							setState(397);
							resid_2_Queue.put(new ProtocolMessage(box.get(),795));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 397:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_3_")) {
							setState(398);
							resid_3_Queue.put(new ProtocolMessage(box.get(),797));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 398:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_4_")) {
							setState(399);
							resid_4_Queue.put(new ProtocolMessage(box.get(),799));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 399:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_5_")) {
							setState(400);
							resid_5_Queue.put(new ProtocolMessage(box.get(),801));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
			...
			switch (state){
				case 400:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_6_")) {
							setState(401);
							resid_6_Queue.put(new ProtocolMessage(box.get(),803));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 401:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_7_")) {
							setState(402);
							resid_7_Queue.put(new ProtocolMessage(box.get(),805));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 402:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_8_")) {
							setState(403);
							resid_8_Queue.put(new ProtocolMessage(box.get(),807));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 403:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_9_")) {
							setState(404);
							resid_9_Queue.put(new ProtocolMessage(box.get(),809));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 404:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_10_")) {
							setState(405);
							resid_10_Queue.put(new ProtocolMessage(box.get(),811));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 405:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_11_")) {
							setState(406);
							resid_11_Queue.put(new ProtocolMessage(box.get(),813));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 406:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_12_")) {
							setState(407);
							resid_12_Queue.put(new ProtocolMessage(box.get(),815));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 407:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_13_")) {
							setState(408);
							resid_13_Queue.put(new ProtocolMessage(box.get(),817));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 408:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_14_")) {
							setState(409);
							resid_14_Queue.put(new ProtocolMessage(box.get(),819));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 409:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_15_")) {
							setState(410);
							resid_15_Queue.put(new ProtocolMessage(box.get(),821));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 410:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_16_")) {
							setState(411);
							resid_16_Queue.put(new ProtocolMessage(box.get(),823));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 411:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_17_")) {
							setState(412);
							resid_17_Queue.put(new ProtocolMessage(box.get(),825));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 412:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_18_")) {
							setState(413);
							resid_18_Queue.put(new ProtocolMessage(box.get(),827));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 413:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_19_")) {
							setState(414);
							resid_19_Queue.put(new ProtocolMessage(box.get(),829));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 414:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_20_")) {
							setState(415);
							resid_20_Queue.put(new ProtocolMessage(box.get(),831));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 415:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.MGThreads.ResidMessage.class ) {
						...
						if (receiver.equals("resid_21_")) {
							setState(416);
							resid_21_Queue.put(new ProtocolMessage(box.get(),833));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
			...
			switch (state){
				...
				case 3:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
						...
						if (receiver.equals("master")) {
							setState(4);
							masterQueue.put(new ProtocolMessage(box.get(),679));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
			...
			switch (state){
				...
				case 2:
					if(!box.isPresent() && !isCloseAction){
						...
						if (objectToGet.OriginalTargetStateId == 817) {
							setState(4);
							//queueFrommasterToresid_13_);
							// Disabling unchecked inspection: We did check the class in the if statement above
							//noinspection unchecked
			...
			switch (state){
				...
				case 3:
					if(!box.isPresent() && !isCloseAction){
						...
						if (objectToGet.OriginalTargetStateId == 819) {
							setState(4);
							//queueFrommasterToresid_14_);
							// Disabling unchecked inspection: We did check the class in the if statement above
							//noinspection unchecked
			...
			switch (state){
				...
				case 1:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
						...
						if (receiver.equals("master")) {
							setState(4);
							masterQueue.put(new ProtocolMessage(box.get(),865));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 4:
					if(!box.isPresent() && !isCloseAction){
						...
						if (objectToGet.OriginalTargetStateId == 821) {
							setState(1);
							//queueFrommasterToresid_15_);
							// Disabling unchecked inspection: We did check the class in the if statement above
							//noinspection unchecked
			...
			switch (state){
				...
				case 1:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
						...
						if (receiver.equals("master")) {
							setState(4);
							masterQueue.put(new ProtocolMessage(box.get(),867));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 4:
					if(!box.isPresent() && !isCloseAction){
						...
						if (objectToGet.OriginalTargetStateId == 823) {
							setState(1);
							//queueFrommasterToresid_16_);
							// Disabling unchecked inspection: We did check the class in the if statement above
							//noinspection unchecked
			...
			switch (state){
				...
				case 1:
					if(!box.isPresent() && !isCloseAction){
						...
						if (objectToGet.OriginalTargetStateId == 825) {
							setState(2);
							//queueFrommasterToresid_17_);
							// Disabling unchecked inspection: We did check the class in the if statement above
							//noinspection unchecked
				...
				case 2:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
						...
						if (receiver.equals("master")) {
							setState(1);
							masterQueue.put(new ProtocolMessage(box.get(),869));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
			...
			switch (state){
				...
				case 1:
					if(!box.isPresent() && !isCloseAction){
						...
						if (objectToGet.OriginalTargetStateId == 827) {
							setState(2);
							//queueFrommasterToresid_18_);
							// Disabling unchecked inspection: We did check the class in the if statement above
							//noinspection unchecked
				...
				case 2:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.DoneMessage.class ) {
						...
						if (receiver.equals("master")) {
							setState(1);
							masterQueue.put(new ProtocolMessage(box.get(),871));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
	...
	public String[] threadNames(){
		return new String[] { "interpd_21_","interpd_3_","interpd_8_","interpd_0_","resid_0_","rprj_13_","rprj_7_","rprj_17_","resid_9_","psinv_6_","resid_5_","rprj_10_","psinv_1_","resid_6_","interpd_9_","rprj_6_","resid_18_","psinv_15_","psinv_8_","interpd_11_","resid_4_","interpd_2_","interpd_4_","interpd_10_","rprj_16_","psinv_10_","rprj_18_","psinv_11_","psinv_12_","interpd_6_","psinv_4_","resid_20_","interpd_19_","interpd_12_","rprj_2_","resid_3_","resid_1_","resid_12_","resid_2_","resid_10_","rprj_19_","interpd_1_","interpd_20_","rprj_14_","psinv_19_","resid_8_","interpd_5_","rprj_8_","resid_19_","interpd_14_","psinv_3_","resid_21_","psinv_18_","psinv_7_","resid_17_","interpd_17_","psinv_0_","psinv_5_","rprj_4_","interpd_7_","resid_15_","master","psinv_9_","rprj_11_","rprj_5_","rprj_3_","psinv_13_","interpd_16_","resid_14_","rprj_12_","resid_11_","interpd_15_","rprj_1_","rprj_9_","resid_13_","rprj_15_","resid_16_","psinv_2_","psinv_14_","rprj_0_","psinv_17_","resid_7_","interpd_13_","interpd_18_","psinv_21_","psinv_16_","rprj_20_","rprj_21_","psinv_20_" };
	}
	...
	public String getState(){
		return "/" + interpd_0_Environment.getState() + "/" + interpd_10_Environment.getState() + "/" + interpd_11_Environment.getState() + "/" + interpd_12_Environment.getState() + "/" + interpd_13_Environment.getState() + "/" + interpd_14_Environment.getState() + "/" + interpd_15_Environment.getState() + "/" + interpd_16_Environment.getState() + "/" + interpd_17_Environment.getState() + "/" + interpd_18_Environment.getState() + "/" + interpd_19_Environment.getState() + "/" + interpd_1_Environment.getState() + "/" + interpd_20_Environment.getState() + "/" + interpd_21_Environment.getState() + "/" + interpd_2_Environment.getState() + "/" + interpd_3_Environment.getState() + "/" + interpd_4_Environment.getState() + "/" + interpd_5_Environment.getState() + "/" + interpd_6_Environment.getState() + "/" + interpd_7_Environment.getState() + "/" + interpd_8_Environment.getState() + "/" + interpd_9_Environment.getState() + "/" + masterEnvironment.getState() + "/" + psinv_0_Environment.getState() + "/" + psinv_10_Environment.getState() + "/" + psinv_11_Environment.getState() + "/" + psinv_12_Environment.getState() + "/" + psinv_13_Environment.getState() + "/" + psinv_14_Environment.getState() + "/" + psinv_15_Environment.getState() + "/" + psinv_16_Environment.getState() + "/" + psinv_17_Environment.getState() + "/" + psinv_18_Environment.getState() + "/" + psinv_19_Environment.getState() + "/" + psinv_1_Environment.getState() + "/" + psinv_20_Environment.getState() + "/" + psinv_21_Environment.getState() + "/" + psinv_2_Environment.getState() + "/" + psinv_3_Environment.getState() + "/" + psinv_4_Environment.getState() + "/" + psinv_5_Environment.getState() + "/" + psinv_6_Environment.getState() + "/" + psinv_7_Environment.getState() + "/" + psinv_8_Environment.getState() + "/" + psinv_9_Environment.getState() + "/" + resid_0_Environment.getState() + "/" + resid_10_Environment.getState() + "/" + resid_11_Environment.getState() + "/" + resid_12_Environment.getState() + "/" + resid_13_Environment.getState() + "/" + resid_14_Environment.getState() + "/" + resid_15_Environment.getState() + "/" + resid_16_Environment.getState() + "/" + resid_17_Environment.getState() + "/" + resid_18_Environment.getState() + "/" + resid_19_Environment.getState() + "/" + resid_1_Environment.getState() + "/" + resid_20_Environment.getState() + "/" + resid_21_Environment.getState() + "/" + resid_2_Environment.getState() + "/" + resid_3_Environment.getState() + "/" + resid_4_Environment.getState() + "/" + resid_5_Environment.getState() + "/" + resid_6_Environment.getState() + "/" + resid_7_Environment.getState() + "/" + resid_8_Environment.getState() + "/" + resid_9_Environment.getState() + "/" + rprj_0_Environment.getState() + "/" + rprj_10_Environment.getState() + "/" + rprj_11_Environment.getState() + "/" + rprj_12_Environment.getState() + "/" + rprj_13_Environment.getState() + "/" + rprj_14_Environment.getState() + "/" + rprj_15_Environment.getState() + "/" + rprj_16_Environment.getState() + "/" + rprj_17_Environment.getState() + "/" + rprj_18_Environment.getState() + "/" + rprj_19_Environment.getState() + "/" + rprj_1_Environment.getState() + "/" + rprj_20_Environment.getState() + "/" + rprj_21_Environment.getState() + "/" + rprj_2_Environment.getState() + "/" + rprj_3_Environment.getState() + "/" + rprj_4_Environment.getState() + "/" + rprj_5_Environment.getState() + "/" + rprj_6_Environment.getState() + "/" + rprj_7_Environment.getState() + "/" + rprj_8_Environment.getState() + "/" + rprj_9_Environment.getState() + "/";
	}
}

...
public class FTProtocol_n_22 implements IProtocol {
	...
	public String[] threadNames(){
		return new String[] { "fft_5_","fft_6_","evolve_0_","evolve_12_","evolve_13_","evolve_14_","evolve_18_","fft_17_","evolve_6_","evolve_11_","fft_8_","fft_4_","fft_16_","evolve_3_","fft_12_","fft_9_","evolve_21_","fft_19_","evolve_7_","fft_3_","evolve_20_","fft_13_","fft_11_","evolve_10_","fft_21_","master","fft_2_","fft_10_","fft_15_","evolve_9_","evolve_1_","evolve_2_","fft_20_","evolve_17_","fft_0_","fft_14_","fft_7_","evolve_19_","evolve_16_","evolve_4_","evolve_15_","evolve_5_","fft_1_","evolve_8_","fft_18_" };
	}
	...
	public String getState(){
		return "/" + evolve_0_Environment.getState() + "/" + evolve_10_Environment.getState() + "/" + evolve_11_Environment.getState() + "/" + evolve_12_Environment.getState() + "/" + evolve_13_Environment.getState() + "/" + evolve_14_Environment.getState() + "/" + evolve_15_Environment.getState() + "/" + evolve_16_Environment.getState() + "/" + evolve_17_Environment.getState() + "/" + evolve_18_Environment.getState() + "/" + evolve_19_Environment.getState() + "/" + evolve_1_Environment.getState() + "/" + evolve_20_Environment.getState() + "/" + evolve_21_Environment.getState() + "/" + evolve_2_Environment.getState() + "/" + evolve_3_Environment.getState() + "/" + evolve_4_Environment.getState() + "/" + evolve_5_Environment.getState() + "/" + evolve_6_Environment.getState() + "/" + evolve_7_Environment.getState() + "/" + evolve_8_Environment.getState() + "/" + evolve_9_Environment.getState() + "/" + fft_0_Environment.getState() + "/" + fft_10_Environment.getState() + "/" + fft_11_Environment.getState() + "/" + fft_12_Environment.getState() + "/" + fft_13_Environment.getState() + "/" + fft_14_Environment.getState() + "/" + fft_15_Environment.getState() + "/" + fft_16_Environment.getState() + "/" + fft_17_Environment.getState() + "/" + fft_18_Environment.getState() + "/" + fft_19_Environment.getState() + "/" + fft_1_Environment.getState() + "/" + fft_20_Environment.getState() + "/" + fft_21_Environment.getState() + "/" + fft_2_Environment.getState() + "/" + fft_3_Environment.getState() + "/" + fft_4_Environment.getState() + "/" + fft_5_Environment.getState() + "/" + fft_6_Environment.getState() + "/" + fft_7_Environment.getState() + "/" + fft_8_Environment.getState() + "/" + fft_9_Environment.getState() + "/" + masterEnvironment.getState() + "/";
	}
}

...
public class CGProtocol_strict_n_20 implements IProtocol {
	...
	private final IEnvironment masterEnvironment = new IEnvironment() {
		...
		public <Any, AnyInput> Optional<Any> exchange_0_101(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			switch (state){
				case 1 :
					wait();
					break;
				...
				case 43:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_1_")) {
							setState(44);
							worker_1_Queue.put(new ProtocolMessage(box.get(),85));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 45:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_2_")) {
							setState(46);
							worker_2_Queue.put(new ProtocolMessage(box.get(),89));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 47:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_3_")) {
							setState(48);
							worker_3_Queue.put(new ProtocolMessage(box.get(),93));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 49:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_4_")) {
							setState(50);
							worker_4_Queue.put(new ProtocolMessage(box.get(),97));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 51:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_5_")) {
							setState(52);
							worker_5_Queue.put(new ProtocolMessage(box.get(),101));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 53:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_6_")) {
							setState(54);
							worker_6_Queue.put(new ProtocolMessage(box.get(),105));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 55:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_7_")) {
							setState(56);
							worker_7_Queue.put(new ProtocolMessage(box.get(),109));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 57:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_8_")) {
							setState(58);
							worker_8_Queue.put(new ProtocolMessage(box.get(),113));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 59:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_9_")) {
							setState(60);
							worker_9_Queue.put(new ProtocolMessage(box.get(),117));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 61:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_10_")) {
							setState(62);
							worker_10_Queue.put(new ProtocolMessage(box.get(),121));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 63:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_11_")) {
							setState(64);
							worker_11_Queue.put(new ProtocolMessage(box.get(),125));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 65:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_12_")) {
							setState(66);
							worker_12_Queue.put(new ProtocolMessage(box.get(),129));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 67:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_13_")) {
							setState(68);
							worker_13_Queue.put(new ProtocolMessage(box.get(),133));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 69:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_14_")) {
							setState(70);
							worker_14_Queue.put(new ProtocolMessage(box.get(),137));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 71:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_15_")) {
							setState(72);
							worker_15_Queue.put(new ProtocolMessage(box.get(),141));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 73:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_16_")) {
							setState(74);
							worker_16_Queue.put(new ProtocolMessage(box.get(),145));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 75:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_17_")) {
							setState(76);
							worker_17_Queue.put(new ProtocolMessage(box.get(),149));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 77:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_18_")) {
							setState(78);
							worker_18_Queue.put(new ProtocolMessage(box.get(),153));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
				...
				case 79:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						...
						if (receiver.equals("worker_19_")) {
							setState(80);
							worker_19_Queue.put(new ProtocolMessage(box.get(),157));
							return Optional.empty();
						}
					}
					if(!box.isPresent() && !isCloseAction){
		...
		public <Any, AnyInput> Optional<Any> exchange(Optional<AnyInput> box, String receiver, boolean isCloseAction) throws Exception{
			if (state >=0 && state <= 101){
				Optional result = exchange_0_101(box, receiver, isCloseAction);
				if(result != null)
	...
	public String[] threadNames(){
		return new String[] { "master","worker_5_","worker_6_","worker_18_","worker_11_","worker_0_","worker_7_","worker_3_","worker_8_","worker_13_","worker_2_","worker_19_","worker_15_","worker_4_","worker_17_","worker_14_","worker_9_","worker_12_","worker_1_","worker_16_","worker_10_" };
	}

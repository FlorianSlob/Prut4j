...
public class FTProtocol_n_5 implements Pr {
	...
	public String[] threadNames(){
		return new String[] { "evolve_3_","evolve_0_","fft_4_","evolve_1_","master","fft_3_","evolve_4_","fft_2_","evolve_2_","fft_0_","fft_1_" };
	}

...
public class CGProtocol_strict_n_4 implements IProtocol {
			...
			switch (state){
				...
				case 1:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_2_","worker_0_","worker_3_","worker_1_" };
				...
				case 5:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(4);
							String[] receiverOptionsArray = new String[]{ "worker_1_","worker_3_","worker_0_","worker_2_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_1_")) {
							setState(7);
				...
				case 7:
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(4);
							String[] receiverOptionsArray = new String[]{ "worker_3_","worker_2_","worker_0_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_3_")) {
							setState(7);
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.ExitMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(4);
							String[] receiverOptionsArray = new String[]{ "worker_1_","worker_2_","worker_3_","worker_0_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_1_")) {
							setState(3);
				...
				case 8:
					...
					if (box.isPresent() && box.get().getClass() == discourje.examples.npb3.impl.CGThreads.CGMessage.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(4);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_1_","worker_2_","worker_3_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(7);
	...
	public String[] threadNames(){
		return new String[] { "worker_1_","master","worker_3_","worker_0_","worker_2_" };
	}

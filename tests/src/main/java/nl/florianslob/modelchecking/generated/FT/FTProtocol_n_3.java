...
public class FTProtocol_n_3 implements IProtocol {
	...
	public String[] threadNames(){
		return new String[] { "fft_1_","fft_0_","master","evolve_2_","fft_2_","evolve_0_","evolve_1_" };
	}
	...
	public String getState(){
		return "/" + evolve_0_Environment.getState() + "/" + evolve_1_Environment.getState() + "/" + evolve_2_Environment.getState() + "/" + fft_0_Environment.getState() + "/" + fft_1_Environment.getState() + "/" + fft_2_Environment.getState() + "/" + masterEnvironment.getState() + "/";
	}
}

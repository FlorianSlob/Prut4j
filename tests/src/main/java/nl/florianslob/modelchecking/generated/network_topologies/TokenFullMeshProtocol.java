...
public class TokenFullMeshProtocol implements Pr {
				...
				case 0:
					if (box.isPresent() && box.get().getClass() == Boolean.class ) {
						if (receiver == null) {
							...
							String[] receiverOptionsArray = new String[]{ "worker_3_","worker_2_","worker_1_" };
			...
			switch (state){
				case 0:
					if (box.isPresent() && box.get().getClass() == Boolean.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(3);
							String[] receiverOptionsArray = new String[]{ "worker_2_","worker_0_","worker_3_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_2_")) {
							setState(1);

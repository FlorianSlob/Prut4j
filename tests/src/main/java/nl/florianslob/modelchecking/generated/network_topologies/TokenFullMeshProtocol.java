...
public class TokenFullMeshProtocol implements IProtocol {
			...
			switch (state){
				...
				case 1:
					if (box.isPresent() && box.get().getClass() == Boolean.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(3);
							String[] receiverOptionsArray = new String[]{ "worker_0_","worker_3_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_0_")) {
							setState(0);
			...
			switch (state){
				...
				case 1:
					if (box.isPresent() && box.get().getClass() == Boolean.class ) {
						if (receiver == null) {
							int rnd = new Random().nextInt(3);
							String[] receiverOptionsArray = new String[]{ "worker_2_","worker_0_","worker_1_" };
							receiver = receiverOptionsArray[rnd];
						}
						if (receiver.equals("worker_2_")) {
							setState(0);
	...
	public String getState(){
		return "/" + worker_0_Environment.getState() + "/" + worker_1_Environment.getState() + "/" + worker_2_Environment.getState() + "/" + worker_3_Environment.getState() + "/";
	}

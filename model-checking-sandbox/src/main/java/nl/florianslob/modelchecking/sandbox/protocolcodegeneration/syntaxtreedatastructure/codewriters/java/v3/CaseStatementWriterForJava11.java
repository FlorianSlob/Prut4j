package nl.florianslob.modelchecking.sandbox.protocolcodegeneration.syntaxtreedatastructure.codewriters.java.v3;
...
//                            (tabCountLvl0) -> {
            ...
            StringBuilderSyntaxHelper.addLine(builder, numberOfPrependingTabs, "ProtocolMessage objectToGet = "+firstAction.communicationChannel.toRole+"Queue.take();");
...
//                            });
            ...
            StringBuilderSyntaxHelper.addLine(builder, numberOfPrependingTabs, "return Optional.of((Any)"+receiveAction.communicationChannel.toRole+"Queue.take().Message);");
        }
    }
}

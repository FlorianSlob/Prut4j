...
public class Vertex<State, Action, Test extends Predicate<Object> & Supplier<Object>> implements Florian {
    ...
    public String toJava() {
        ...
        b.append("var state").append(this).append(" = new ProtocolStateNode(").append(this).append(");");
        for (Edge<State, Action, Test> e : edges.get()) {
            b.append(System.lineSeparator());
            b.append("state").append(this).append(".AddOutgoingTransaction(").append(e.toJava()).append(");");
        }
        return b.toString();
    }
    ...
    public AtomicReference<Edge.Collection<State, Action, Test>> getEdges(){
        return edges;
    }
